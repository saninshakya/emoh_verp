...
class Googlemaps {
	...
	var $mapTypeControlPosition		= 'BOTTOM_LEFT';			// The position of the MapType control, eg. 'BOTTOM_RIGHT'
	...
	var $streetViewAddressPosition	= 'BOTTOM_LEFT';			// The position of the Address control, eg. 'BOTTOM'
	var $streetViewControlPosition	= 'BOTTOM_LEFT';			// The position of the Street View control when viewing normal aerial map, eg. 'BOTTOM_RIGHT'
	...
	var $streetViewPanPosition		= 'BOTTOM_LEFT';			// The position of the Scale control, eg. 'TOP_RIGHT'
	...
	//2015-11-10 Add by Ball
	var $placeMarker				= 'placeMarker(event.latLng);';						// Move Marker by click on the Map
	...
	function add_marker($params = array())
	{
		...
		$marker['icon'] = '/img/pin-property.png';				// The name or url of the icon to use for the marker
