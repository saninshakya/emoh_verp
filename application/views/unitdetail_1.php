      ...
      ?>
         ...
         <!-row c->
          <div class="col-md-12 text-grey text-left">
                ...
                <div class="target-rc display-none">
                    ...
                    <div class="col-md-4"> 81,000.00<br><span class="small2">(2.5% ของราคาหักค่าธรรมเนียม)</span></div>
        ...
        <!-row d->
          <div class="col-md-12 text-grey text-left">
                ...
                <div class="col-md-4"><h5 class="text-grey">- ระยะเวลากู้ 20ปี ดอกเบี้ย 6.5% </h5></div>
                <div class="col-md-4"> <h5 class="text-grey">฿135,000/เดือน</h5></div>
                <div class="clearfix"></div>
                <!-hide c->
                <div class="target-rd display-none">
                    
                    <div class="col-md-4"></div><div class="col-md-4"> - ยอดเงินกู้</div><div class="col-md-4">฿11,250,000</div>
                    <div class="clearfix">&nbsp;</div>
