...
<div class="container padding-right-clear padding-left-clear">
	...
	<div class="col-md-2 mobile-nopadding">
		<div class="visible-xs visible-sm padding-none3">
			<div class="clearfix"></div>
			<div class="hidden-xs hidden-sm clear-margin-padding col-md-12  col-sm-12 col-xs-12 bg-grey4 fixed5"  style="z-index:1">
				...
				<div class="col-xs-3 q-dash-favourite text-center <?php if($type=='profile'){echo "q-dash-active";}?>">
					<span>
