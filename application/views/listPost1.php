<?php
	$query=$this->backend->listPost(1,1,0)
?>
<br>
<br>
<div align="Center">รายการรอการตรวจสอบ <b>ประเภทขายคอนโด</b></div>
<br>
...
?>
	<tr class="<?if($row->StatusUpdate==1){echo "text-green";}?>">
		<td align="center">&nbsp;<?=$i;?>&nbsp;<?=$this->backend->duplicateRoom($row->PID,$row->Address,"null",1);?></td>
		...
		<td align="right">&nbsp;<?=number_format($row->TotalPrice, 0,'',',');?>&nbsp;</td>
		...
		<td align="center">&nbsp;<a href="/zhome/adminDelUnit/<?=$row->POID;?>/1" onclick="return confirm('แน่ใจลบประกาศ?')">ลบ</a>&nbsp;</td>
	</tr>
<?php
	 $i++;
	}
...
<?php
	$query=$this->backend->listPost(1,1,3)
?>
<br>
<br>
<div align="Center">รายการแจ้งให้แก้ไข <b>ประเภทขายคอนโด</b></div>
<br>
<table border="1" align="center">
	<tr>
		<td align="center">&nbsp;ลำดับที่&nbsp;</td>
