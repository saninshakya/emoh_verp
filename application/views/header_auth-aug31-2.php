				...
				<div class="navbar-header">
					<div class="row">
						...
						<ul class="nav navbar-nav navbar-right padding-none visible-xs visible-sm w70 pull-right">
							...
							<li class="pull-right padding-t6  text-white" style="margin-top:9px; margin-right:0px; margin-left:15px;" onclick="javascript:location.href='/zhome/payment'"><span class="text-white cursor"><?=$this->credit->CreditBanlance();?></span></li>
							...
							<li class="button pull-right padding-bottom2 margin-r3" title="Dashboard">
								<!--<a href="/zhome/dashboard" class="imgthumb hidden-xs hidden-sm" alt="Dashboard">-->
								<a href="/zhome/dashboard" class="imgthumb" title="Dashboard">
									<img src="<?php echo $image;?>" class="img-circle navbar-brand-img" alt="Profile Picture">
									<span class="button__badge"><?=$CNumber;?></span>
								</a>
							</li>
						</ul>
					  ...
					  <ul class="nav navbar-nav navbar-right">
						<!--<li class="hidden-xs hidden-sm"><a href="/zhome/dashboard" class="imgthumb hidden-xs hidden-sm"><img src="<?php echo $image;?>" class="img-circle navbar-brand-img" alt="Dashboard"> <div class="margin-t4 text-white pull-left"><?=$CNumber;?></div></a></li>-->
						 <li class="button hidden-xs hidden-sm margin-r9">
						  ...
						  <li class="class="button hidden-xs hidden-sm margin-r9 display-none" style="padding-top:14px;padding-left:7px" onclick="javascript:location.href='/zhome/payment'"><span class="text-white cursor">ซื้อเหรียญ</span>
						  </li>
						  <li class="button hidden-xs hidden-sm" style="padding-top:16px; padding-right:7px">

								<img src="/img/zcoin01.png" width="16px" height="16px" onclick="javascript:location.href='/zhome/payment'">
						  </li>
...
function checkpayment1(){
	...
	var howmany = $('#optionsRadios1').val();
    if (howmany== "100")
    { $("#text-payment-bt").text("โปรโมท 100 ครั้ง/วัน ถึง __/__/__");
    }
}


function checkpayment2(){
    var howmany = $('#optionsRadios2').val();
    if (howmany== "300")
    { $("#text-payment-bt").text("โปรโมท 300 ครั้ง/วัน ถึง __/__/__");
    }
}
function checkpayment3(){
	var howmany = $('#optionsRadios3').val();
	$('#option_custom2').val()=="";
    if (howmany== "500")
    { $("#text-payment-bt").text("โปรโมท 500 ครั้ง/วัน ถึง __/__/__");
    }
}

function checkpayment4(){
	var howmany = $('#option_custom2').val();
    $("#text-payment-bt").text("โปรโมท"+$('#option_custom2').val()+"ครั้ง/วัน ถึง __/__/__");
...
/*function checkpayment(){
    ...
    var howmany = document.getElementsByName("optionsRadios2").val();
    alert('howmany');
    if (howmany== "option1")
    { $("#text-payment-bt").text("โปรโมท 100 ครั้ง/วัน ถึง __/__/__");
    }
    else if (howmany == "option2")
    { $("#text-payment-bt").text("โปรโมท 300 ครั้ง/วัน ถึง __/__/__");
    }
    else if (howmany == "option3")
    { $("#text-payment-bt").text("โปรโมท 500 ครั้ง/วัน ถึง __/__/__");
    }
    else (howmany == "option4")
    { $("#text-payment-bt").text("โปรโมท "+howmany+"ครั้ง/วัน ถึง __/__/__");
    }
}
*/
