...
function displayImgUnits(){
  ...
  for(var i=0;i<imgUnits.length;i++){
    ...
    imgNode +=  '<div class="col-md-4 col-sm-6" id="'+imgUnits[i].POID+'">';
        imgNode +=  '<img src="'+imgUnits[i].Picture[0]+'" class="t-img-responsive center-block" width="360px" height="172px">';
        ...
        imgNode +=  '<td><span class="text-blue">'+imgUnits[i].DateShow+' </span> <img src="/img/sun-s-icon.png"> <span class="text-blue"> '+imgUnits[i].ViewTel+' </span> <span width="3px" class="glyphicon glyphicon-earphone text-blue input-sm3"></span></td>';
