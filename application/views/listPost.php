<?php
	$query=$this->backend->listPost(1,2,0)
?>
<br>
<br>
<div align="Center">รายการรอการตรวจสอบ <b>ประเภทขายดาวน์ คอนโด</b></div>
<br>
...
?>
	<tr class="<?if($row->StatusUpdate==1){echo "text-green";}?>">
		<td align="center">&nbsp;<?=$i;?>&nbsp;<?=$this->backend->duplicateRoom($row->PID,"null",$row->RoomNumber,2);?></td>
		...
		<td align="center">&nbsp;<a href="/zhome/adminDelUnit/<?=$row->POID;?>/2" onclick="return confirm('แน่ใจลบประกาศ?')">ลบ</a>&nbsp;</td>
	</tr>
<?php
	 $i++;
	}
...
<?php
	$query=$this->backend->listPost(1,2,3)
?>
<br>
<br>
<div align="Center">รายการแจ้งให้แก้ไข <b>ประเภทขายดาวน์ คอนโด</b></div>
<br>
<table border="1" align="center">
	<tr>
		<td align="center">&nbsp;ลำดับที่&nbsp;</td>
