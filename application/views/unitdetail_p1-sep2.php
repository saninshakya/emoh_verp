...
<div class="container-fluid clear-margin-padding">
	<div class="col-xs-12 col-md-7 col-md-offset-1 resize-mobile padding-lr0 ">
		<!--photo-->
		...
		<!--end photo-->
		<br/>
		<div class="col-xs-12 text-center bg-grey6">
			<strong><?=$Address_show;?></strong>
		</div>
	</div><!--end col-md-7-->

	<div class="unitdetail-sidebar col-md-3 col-xs-12">
		<!--right box-->
		...
		<div class="col-xs-12 nopadding border-grey2">
			<div class="col-xs-12 bg-box-grey q-price-div">
				<div class="col-xs-8 col-md-12 col-lg-8 nopadding">
				...
				<div class="col-xs-4 col-md-12 col-lg-4 text-right text-left-md" style="padding:13px 0px 0px 0px;">
			...
			<?if($rowUnit->Active!=81 and $rowUnit->Active!=82){?>
				<div class="col-md-12 report-div text-center">
					<div class="col-xs-12 bluetel bg-blue text-white text-center padding-t5x padding-b5x padding-clear-bottom">
						<div id="<?if($countViewTel==0){echo "down-b1";}?>">
							...
							<ul class="nomargin list-inline">
								...
								<li class="height-22"><h7 class="text-white"><a class="showtel text-white" style="cursor:pointer;"><?=$Tel;?></a></h7></li>
							</ul>
						</div>
								...
								<div class="item q-unit-item thumbnail-banner <?if($i==0){echo "active";}?>">
									<div style="background-image:url('<?=$Banner[$i]['Picture'];?>');background-repeat: no-repeat;background-position: center center;background-size:cover; padding-left: 0; padding-right: 0;">
										<div style="right:1%;top:1%;z-index:10;padding-top:5px;color:#fff;text-align:right;text-shadow:1px 1px 2px black,0 0 10px black,0 0 5px darkblue;height:100%;">
											...
											<a href="/<?=$Banner[$i]['NamePath'];?>/condo/<?=$Banner[$i]['PName_en'];?>/<?=$Banner[$i]['POID'];?>" target="_blank" alt="<?=$Banner[$i]['AdvertisingName'];?>-<?=$Banner[$i]['PropertyName'];?>-<?=$Banner[$i]['ProjectNameAnchor'];?>" style="text-decoration: none;">
												...
												<div class='unit-item-textset' style="margin-bottom:40px;z-index:10;padding-bottom:1px;padding-left:2%;color:#fff;text-align:left;text-shadow:1px 1px 2px black,0 0 10px black,0 0 5px darkblue;width:100%;background: linear-gradient(rgba(255,255,255,0),rgba(51,51,51,0.8));position:absolute;bottom:0px;">
													...
													<div class="text-white"><span class="dprice"><?=$Banner[$i]['PriceShow'];?></span> | <span><?=$Banner[$i]['Bedroom'];?></span> | <span> <?=$Banner[$i]['Bathroom'];?></span> | <span><?=$Banner[$i]['useArea']." ม&sup2";?></span></div>
													<div class="text-white font14"><span><?=$Banner[$i]['ProjectNameCenter']." (".$Banner[$i]['DistName'].")";?></span></div>
												</div>
											</a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content text-center">
				...
				<div class="modal-body text-grey row text-center">
					...
					<div class="col-xs-12 padding-top10 modal-warnning-select">
