          ...
          <div class="padding-bottom5 container-fluid">
            <div class="col-md-4">
              <div class="pull-left w20">
                <input type="text" class="form-control" value="" id="iDistance" name="iDistance" placeholder="0"> 
              </div>
              ...
              <div class="pull-left w65 border-right text-center">
                <input type="text"  class="form-control" value=""    id="iRefPlace" name="iRefPlace"  placeholder=" เขต, รถไฟฟ้า, โครงการ" autocomplete="off">
              </div>
            ...
            <div class="col-md-4">
               ...
               <div class="pull-left w30 text-center">
                  <input type="text"  class="form-control" value="" id="minPrice" name="minPrice" placeholder=" ราคาต่ำสุด">  
               ...
               <div class="pull-left w30 border-right text-center">
                  <input type="text"   class="form-control" value="" id="maxPrice" name="maxPrice" placeholder=" ราคาสูงสุด">
      ...
      <!--End slider menu -->
        ...
        <div class="row">
         ...
         <div id="float_menu3" class="text-center hidden-xs">
          ...
          <select class="form-control input-md no-border selectpicker text-center" data-style="btn-noborder" data-width="100%" id="nOptSearch">
...
function displayImgUnits(){
	...
	for(var i=0;i<imgUnits.length;i++){
        ...
        imgNode +=  '<div><div class="unit-show"><div style="padding-left:13px;"><h3 class="padding-none"> '+imgUnits[i].ProjectName+'</h3></div>';
        ...
        imgNode +=	 '<table class="table borderless2 fsize-unitsearch">';
        ...
        imgNode +=  '<td class="text-right"><strong>B <span class="text-primary text-right">'+imgUnits[i].PricePerSq+'</span></span>/ม&sup2;.</td>';
        imgNode +=  '</tr>';
        imgNode +=  '<tr style="border-bottom: 1px solid #dbdbdb">';
