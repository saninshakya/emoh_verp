<?php
  ...
  $queryAllPost=$this->unitdetail->getAllPostFromPIDandTOAdvertising($PID,$TOAdvertising,$Active);
  //echo $PID;
  //echo $rowUnit->Lat;
  //echo $rowUnit->Lng;
...
<div class="container">
          ...
          <div class="col-md-12">
            <div class="col-md-4 col-xs-4">
			   ...
			   <?php 
					if ($project!=null){
			   ?>
				<span class="pull-left"><?=$DistBTSMRT[2];?></span>
				<span class="pull-right"><?=$DistBTSMRT[0];?> กม.</span>
				<?php 
					 } else {
				 ?>
            ...
            <div class="col-md-4 col-xs-4 text-center border-left">
			   ...
			   <?php 
					if ($project!=null){
			   ?>
				<span class="pull-left"><?=$DistExpressway[2];?></span>
				<span class="pull-right"><?=$DistExpressway[0];?> กม.</span>
				<?php 
					 } else {
				 ?>
				 <span class="pull-left">ไม่มีข้อมูลโครงการ</span>
            ...
            <div class="col-md-4 col-xs-4 text-center border-left">
			   ...
			   <?php 
					if ($project!=null){
			   ?>
					<span class="pull-left"><?=$DistMinimart[2];?></span>
					<span class="pull-right"><?=$DistMinimart[0];?> กม.</span>
				<?php 
					 } else {
				 ?>
				 <span class="pull-left">ไม่มีข้อมูลโครงการ</span>
      ...
      ?>
        ...
        <!-row c->
          <div class="col-md-12 text-grey text-left">
                <div class="col-md-4">สินเชื่อ</div><div class="col-md-4">- ระยะเวลากู้ <?=$PLoanMonth;?> ปี ดอกเบี้ย <?=$PLoan;?>% </div><div class="col-md-4"> ฿<?=number_format($PayPerMonth, 0,'',',');?></div>
                <div class="clearfix"></div>
                <!-hide c->
                <div class="target-rc display-none">
                    ...
                    <div class="clearfix">&nbsp;</div>
                    <div class="col-md-4"></div><div class="col-md-4">เงินเดือน (ปลอดภาระ)</div><div class="col-md-4"><input class="btn-sm" id="x1" onchange="Function_CreditLineMulti()"></div>
                    <div class="col-md-4"></div><div class="col-md-4">ระบุอัตราดอกเบี้ย (%) </div><div class="col-md-4"><input class="btn-sm" id="x2" value="6.5"  onchange="Function_CreditLineMulti()"></div>
          <div class="col-md-4"></div><div class="col-md-4">ระยะเวลากู้ <small class="text-grey">(สูงสุด 30 ปี/65-อายุผู้กู้)</small></div><div class="col-md-4" ><input class="btn-sm" id="x3" value="20"  onchange="Function_CreditLineMulti()"></div>
          <input type="hidden" id="x4" value="<?=$rowUnit->DTransferPayment;?>">
                    <div class="clearfix">&nbsp;</div>
                    <div class="col-md-4"></div><div class="col-md-4">ความสามารถในการผ่อน*</div>
                    <div class="col-md-4" ><input class="btn-sm borderless2" type="text" id="showPayPerMonth" disabled></div>
                    <div class="col-md-4"></div><div class="col-md-4">ประมาณยอดเงินที่กู้ได*้</div>
                    <div class="col-md-4" ><input class="btn-sm borderless2" type="text" id="showLoan" disabled></div>
                    <div class="col-md-4"></div><div class="col-md-4"> ชำระโครงการเพิ่ม ณ วันโอน</div>
                    <div class="col-md-4" style="padding-bottom:40px;"><input class="btn-sm borderless2" type="text" id="showPayTransfer" disabled></div>
                </div>
                <!-end hide c->
        ...
        <div class="col-md-4">
          ...
          <div class="row border-grey2">
             <div class="col-md-12 min-height2">
               <ul class="list-inline2 pull-right">
            ...
            <div class="col-md-12 bg-grey">
                <ul class="list-inline padding-top1">
                      <li class="pull-left"><h3 class="text-white padding-none">฿<?=$TotalPrice;?></h3></li>
                      <li class="text-white pull-right"><h8>B <?=number_format($rowUnit->PricePerSq, 0,'',',');?>/ม<sup>2</sup></h8></li>                      
                </ul>
                <div class="clearfix"></div>
                <hr class="text-white padding-none2">
                <div class=" padding-top4"></div>
                <div class="col-xs-2 text-white padding-clear">
                   <ul class="list-inline">
                     <li class="pull-right"> <h6>นอน</h6></li><br>
                     <li class="pull-right h7">
						<?php
                ...
                <div class="col-xs-4 text-white border-left padding-clear">
                  <ul class="list-inline">
                    <li class="pull-left"><h6>น้ำ</h6></li>
                    <li class="pull-right"><h6>ตร.ม.</h6></li><br>
                    <li class="pull-left h7"><?=$rowUnit->Bathroom;?></li>
                    <li class="pull-right h7"><?=$sumArea;?></li>
                  </ul>
                </div>
                <div class="col-xs-4 text-white border-left padding-clear">
                  <ul class="list-inline">
                    <li class="pull-left"><h6>ตร.ว.</h6></li>
                    <li class="pull-right"><h6>ทิศ</h6></li><br>
                    <li class="pull-left h7">---</li>
                    <li class="pull-right h7"><?=$Direction;?></li>
                  </ul>
                </div>
                <div class="col-xs-2 text-white border-left padding-clear">
                  <ul class="list-inline">
                    <li class="pull-left"><h6>ชั้น</h6></li><br>
                    <li class="pull-left h7"><?=$rowUnit->Floor;?></li>
                  </ul>
                </div>
                <br>
            ...
            <div class="col-md-10 bg-blue text-white text-center padding-top2">
              ...
              <a class="text-white" href="#">ขออภัย พร้อมแสดงผล 1/10/58</a>
            </div> 
             <div class="col-md-1"></div> 
...
<div class="col-md-12 blog-bg-grey">
    ...
    <div class="col-md-6 text-center"><h3 class="text-white copyright">THE BETTER INFORMATION YOU GIVE,<br>
