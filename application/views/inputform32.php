...
<input type="hidden" name="DAllPayment" id="DAllPayment" value="<?php echo $this->post->checkPost('DAllPayment');?>">
...
//	$totalArea=($this->post->checkPost('useArea'))+($this->post->checkPost('terraceArea'));
  $totalArea=($this->post->checkPost('useArea'));
...
<div class="container">
	<div class="row">
		<div class="col-md-7 col-md-push-2">
			...
			<hr>
			<div class="row">
				<div class="col-md-12"><h5><?=$qLabel['residence_detail_preemption'][0];?></h5></div>
				<div class="col-md-8"><?=$qLabel['residence_detail_preemption_price'][0];?></div>
				<div class="col-md-4">
					<p><span class="text-green" id="showDTotalPrice">฿<?php echo number_format($this->post->checkPost('DTotalPrice'),0,'.',',');?></span> (<span class="text-green" id="showPricePerSq">฿<?php echo number_format($PricePerSq,0,'.',',');?></span>/ตร.ม.)</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8">
				...
				<div class="col-md-4">
					<p><span class="text-green" id="showDDownTotalPrice">฿<?php echo number_format($this->post->checkPost('DDownTotalPrice'),0,'.',',');?></span></p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8">- ผ่อนดาวน์กับโครงการอีก</div>
				<div class="col-md-4">
					<p><span class="text-green" id="showDStalePayment2">฿<?php echo number_format($this->post->checkPost('DStalePayment'),0,'.',',');?></span> (<span class="text-green" id="showDStalePaymentMonth"><?php echo  $this->post->checkPost('DStalePaymentMonth');?></span> งวด)</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8">- โอนกรรมสิทธิ ณ กรมที่ดิน</div>
				<div class="col-md-4">
					<p><span class="text-green" id="showDTransferPayment2">฿<?php echo number_format($this->post->checkPost('DTransferPayment'),0,'.',',');?></span></p>
				</div>
			</div>
			<hr>
			<div class="row">
				<div class="col-md-8">
					<h5 id="showDNetPrice9"><?=$qLabel['dnetprice'][0];?><a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="หักส่วนลดแล้ว" ><span class="glyphicon glyphicon-info-sign text-turq2 input-sm  padding-clear" aria-hidden="true"></span></a></h5>
					<div class="col-md-6 padding-left-clear padding-right-clear2">
						<input class="form-control input-z" type="text" name="showDNetPrice" id="showDNetPrice" value="฿<?php echo number_format($this->post->checkPost('DNetPrice'),0,'.',',');?>" onclick="this.value=document.getElementById('DNetPrice').value" onchange="changeFormat('showDNetPrice','DNetPrice');calDAllPayment();setTimeout(function(){calDTotalPrice()}, 100);"  OnKeyPress="return chkNumber(this)" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['dnetprice_title'][0];?>" onmouseover="show_title('<?=$qLabel['dnetprice_title'][0];?>');" onmouseout="hide_title();">
					</div>
					<div class="col-md-6">&nbsp;</div>
				</div>
				<div class="col-md-4">
                <h5 id="showAgreePostDay9"><?=$qLabel['agreepostday'][0];?><a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="ไม่ขึ้นราคาเมื่อมีผู้โทรมาสอบถาม" ><span class="glyphicon glyphicon-info-sign text-turq2 input-sm  padding-clear" aria-hidden="true"></span></a></h5>
            ...
            <div class="row">
				<div class="col-md-4">
					<h5><?=$qLabel['dchangecontractprice'][0];?><a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="ไม่ต้องระบุหากสามารถนำไปลดงวดโอนได้" ><span class="glyphicon glyphicon-info-sign text-turq2 input-sm padding-clear" aria-hidden="true"></span></a></h5>
					<input class="form-control input-z" type="text" name="showDChangeContractPrice" id="showDChangeContractPrice" value="฿<?php echo number_format($this->post->checkPost('DChangeContractPrice'),0,'.',',');?>" onclick="this.value=document.getElementById('DChangeContractPrice').value" onchange="changeFormat('showDChangeContractPrice','DChangeContractPrice');setTimeout(function(){calDTotalPrice()}, 100);" OnKeyPress="return chkNumber(this)" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['dchangecontractprice_title'][0];?>" onmouseover="show_title('<?=$qLabel['dchangecontractprice_title'][0];?>');" onmouseout="hide_title();">
				</div>
            ...
            <hr/>
			<div class="row">
				<div class="col-md-12"><h5><?=$qLabel['dallpayment_prefix'][0];?></h5></div>
				<div class="clearfix"></div><br>
				<div class="col-md-12">
					<h5 id="showDAllPayment9"><?=$qLabel['dallpayment'][0];?><a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="รวมเงินจอง ทำสัญญา ผ่อนดาวน์ที่ต้องชำระกับโครงการทั้งหมดไม่รวมโอน" ><span class="glyphicon glyphicon-info-sign text-turq2 input-sm padding-clear" aria-hidden="true"></span></a></h5>
				</div>
				<br>
				<div class="col-md-4">
					<input class="form-control input-z" type="text" name="showDAllPayment" id="showDAllPayment" value="฿<?php echo number_format($this->post->checkPost('DAllPayment'),0,'.',',');?>" onclick="this.value=document.getElementById('DAllPayment').value" onchange="changeFormat('showDAllPayment','DAllPayment');calDAllPayment();setTimeout(function(){calDDownTotalPrice()}, 100);showDTransferPayment2();" OnKeyPress="return chkNumber(this)" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['dallpayment_title'][0];?>" onmouseover="show_title('<?=$qLabel['dallpayment_title'][0];?>');" onmouseout="hide_title();">
				</div>
				<div class="col-md-4" id="showDTransferPayment3" style="padding-top:8px;">
					<span> <?php if($this->post->checkPost('DTransferPayment')!=0){?>
					ยอดโอน ฿<?=number_format($this->post->checkPost('DTransferPayment'),0,'.',',');?></span>
					<?php } else {echo "&nbsp;";};?>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-md-8">
					<h5 id="showDReadyPayment9"><?=$qLabel['dreadypayment'][0];?><a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="เงินจอง+ทำสัญญา+ผ่อนดาวน์ที่จ่ายไปแล้ว" ><span class="glyphicon glyphicon-info-sign text-turq2 input-sm padding-clear" aria-hidden="true"></span></a></h5>
					<div class="col-md-6 padding-left-clear padding-right-clear2">
						<input class="form-control input-z" type="text" name="showDReadyPayment" id="showDReadyPayment" value="฿<?php echo number_format($this->post->checkPost('DReadyPayment'),0,'.',',');?>" onclick="this.value=document.getElementById('DReadyPayment').value" onchange="changeFormat('showDReadyPayment','DReadyPayment');setTimeout(function(){calDDownTotalPrice()}, 100);" OnKeyPress="return chkNumber(this)" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['dreadypayment_title'][0];?>" onmouseover="show_title('<?=$qLabel['dreadypayment_title'][0];?>');" onmouseout="hide_title();">
                    </div>
                    <div class="col-md-6">
						<div id="showDStalePayment" class="padding-t10">
						<?php
                        if ($this->post->checkPost('DStalePayment')!=0){
							echo $qLabel['dstalepayment'][0];?> ฿<?=number_format($this->post->checkPost('DStalePayment'),0,'.',',');
						}?>
						</div>
                    </div>
				</div>
				...
				<div class="col-md-4">
					<h5><?=$qLabel['historydpayment'][0];?></h5>
					<select class="form-control input-z" style="margin-top:23px;"> name="HistoryDPayment" id="HistoryDPayment" onchange="updatePost('HistoryDPayment');" onmouseover="show_title('<?=$qLabel['historydpayment_title'][0];?>');" onmouseout="hide_title();">
			...
			<div class="row">
				<div class="col-md-4">
					<h5 id="showDStalePaymentMonth9"><?=$qLabel['dstalepayment_period'][0];?></h5>
					<input class="form-control input-z" type="text" name="DStalePaymentMonth" id="DStalePaymentMonth" value="<?php echo $this->post->checkPost('DStalePaymentMonth');?>" onchange="updatePost('DStalePaymentMonth');showDStalePaymentMonth();"  OnKeyPress="return chkNumber(this)" onmouseover="show_title('<?=$qLabel['dstalepayment_period_title'][0];?>');" onmouseout="hide_title();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<input class="form-control input-z" type="hidden" name="showDTransferPayment" id="showDTransferPayment" value="฿<?php echo number_format($this->post->checkPost('DTransferPayment'),0,'.',',');?>" onclick="this.value=''" onchange="changeFormat('showDTransferPayment','DTransferPayment');setTimeout(function(){calDDownTotalPrice()}, 100);showDTransferPayment2();">
				</div>
			</div>
			<br>
			<hr/>
            <div class="row">
				...
				<div class="col-md-4">
                    ...
                    <div class="title-z">อื่นๆ</div>
                    <input class="form-control input-z" type="text" placeholder="ระบุ"name="DFreeETC" id="DFreeETC"  value="<?php echo $this->post->checkPost('DFreeETC');?>" onchange="updatePost('DFreeETC');">
				</div>
				<div class="col-md-4">
                    <br class="visible-xs visible-sm">
                    <div class="checkbox table-bordered padding-checkbox">
		...
		<div class="col-md-3 col-md-push-2 property-info hidden-xs">
			<div class="text-center">
                <h3 class="z-tip">ให้ราคา-ค่าใช้จ่ายครบ<div class="padding-tip-top">ผู้ซื้อพิจารณาง่าย</div></h3>
                <br>
