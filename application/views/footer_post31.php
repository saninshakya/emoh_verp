...
function enableForm(){
	...
	if (x==1){
		...
		document.getElementById('showPRentPrice').disabled=false;
	} else {
		document.getElementById('PRentNational').disabled=true;
		document.getElementById('PRentEnd').disabled=true;
		document.getElementById('showPRentPrice').disabled=true;
	}
}
...
function CalTotalPrice(){
	...
	document.getElementById('TotalPrice').value=a;
...
function changeformat(){
	...
	AssetPrice=parseFloat(AssetPrice.replace(/\,/g,''));
...
function changeformat2(){
	/*var myMoney=document.getElementById('showRRentPrice').value;
	myMoney=parseInt(myMoney.replace(/\,/g,''));
	document.getElementById('RRentPrice').value=myMoney;
	updatePost('RRentPrice');
	document.getElementById('showRRentPrice').value='฿'+formatDollar(myMoney);*/
...
function changeformat5(){
	var myMoney=document.getElementById('DepositPrice').value;
	myMoney=parseInt(myMoney.replace(/\,/g,''));
	document.getElementById('HDepositPrice').value=myMoney;
	document.getElementById('DepositPrice').value=myMoney;
	updatePost('DepositPrice');
	document.getElementById('DepositPrice').value='฿'+formatDollar(myMoney);
	var b=Number(document.getElementById('HDepositPrice').value);
	var a=Number(document.getElementById('TotalPrice').value);
	var c=Number(document.getElementById('TotalTax').value);
	var d=Number(document.getElementById('DepositPrice').value);
	document.getElementById('DDepositPrice').value=a-b;
	updatePost('DDepositPrice');
	document.getElementById("ShowPrice").innerHTML = formatDollar(a-b);
}
...
function submitFormPage3(){
	var a=document.getElementById("HNetPrice").value;
	var b=Number(document.getElementById("StatusPRent").value);

	if (a=="" || a==0){
		document.getElementById("showNetPrice").className = "error_msg";
	} else {
		document.getElementById("showNetPrice").className = "normal_msg";
	}
