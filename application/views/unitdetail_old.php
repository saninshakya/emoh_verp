...
$location=array();
$rowUnit=$unit->row();
array_push($location[],$rowUnit->ProjectName,$rowUnit->Lat,$rowUnit->Lng,'','/img/pin-property.png');
if ($project!=null){
...
if($DistBTSMRT){
	array_push($location,$DistBTSMRT[2],$DistBTSMRT[3],$DistBTSMRT[4],$DistBTSMRT[0],$DistBTSMRT[5]);
}
if($DistEducation){
	array_push($location,$DistEducation[2],$DistEducation[3],$DistEducation[4],$DistEducation[0],$DistEducation[5]);
}
if($DistHospital){
	array_push($location,$DistHospital[2],$DistHospital[3],$DistHospital[4],$DistHospital[0],$DistHospital[5]);
}
if($DistShopingMall){
	array_push($location,$DistShopingMall[2],$DistShopingMall[3],$DistShopingMall[4],$DistShopingMall[0],$DistShopingMall[5]);
}
if($DistExpressway){
	array_push($location,$DistExpressway[2],$DistExpressway[3],$DistExpressway[4],$DistExpressway[0],$DistExpressway[5]);
}
if($DistMinimart){
	array_push($location,$DistMinimart[2],$DistMinimart[3],$DistMinimart[4],$DistMinimart[0],$DistMinimart[5]);
}
...
<div class="container">
            ...
            <div class="col-md-12 bg-box-grey">
               <div class="col-md-12"">
                <ul class="list-inline padding-top3 padding-lr2">
                      ...
                      <li class="text-white pull-right padding-top6"><h8>฿ <?=number_format($rowUnit->PricePerSq, 0,'',',');?>/ม<sup>2</sup></h8></li>
                </ul>
                ...
                <div>
                      ...
                      <div class="pull-left border-left padding-l5 w12">
                         ...
                         <div class="h7 text-white">
							<span class="glyphicon <?php if($rowUnit->TOOwner=='1'){echo 'glyphicon-remove';}else{echo 'glyphicon-ok';}?>" aria-hidden="true" style="font-size:17px;"></span>
						 </div>
                      </div>
                  </div>
        ...
        <!-end move->
        <div class="col-md-8 col-md-pull-4 resize-mobile">
          <br/>
          ...
          <div class="col-md-12 target-r1 display-none">
            <div class="col-md-4 col-xs-4">
              <div class="text-grey padding-top1">
			   <?php 
					if ($project!=null){
			   ?>
					<span class="pull-left"><?=$DistBTSMRT[14];?></span>
					<span class="pull-right"><?=$DistBTSMRT[12];?> กม.</span>
				<?php 
					 } else {
				 ?>
				 <span class="pull-left">ไม่มีข้อมูลโครงการ</span>
            ...
            <div class="col-md-4 col-xs-4 text-center border-left">
			   ...
			   <?php 
					if ($project!=null){
			   ?>
					<span class="pull-left"><?=$DistExpressway[14];?></span>
					<span class="pull-right"><?=$DistExpressway[12];?> กม.</span>
				<?php 
					 } else {
				 ?>
				 <span class="pull-left">ไม่มีข้อมูลโครงการ</span>
            ...
            <div class="col-md-4 col-xs-4 text-center border-left">
			   ...
			   <?php 
					if ($project!=null){
			   ?>
					<span class="pull-left"><?=$DistMinimart[14];?></span>
					<span class="pull-right"><?=$DistMinimart[12];?> กม.</span>
				<?php 
					 } else {
				 ?>
				 <span class="pull-left">ไม่มีข้อมูลโครงการ</span>
      ...
      ?>
        ...
        <!-row b->
          ...
          ?>
                    <div class="col-md-4 col-xs-4 padding-top10">&nbsp;</div><div class="col-md-4">ผ่อนดาวน์อีก</div><div class="col-md-4 col-xs-4"><?=$DPayment->num_rows();?> งวด</div>
          <?php
          ...
          ?>
                    <div class="col-md-4 col-xs-4">&nbsp;</div><div class="col-md-4 col-xs-4">   งวดที่ <?=$rowDPayment->DPaymentTime;?></div><div class="col-md-4 col-xs-4">฿<?=number_format($rowDPayment->DPaymentPrice, 0,'',',');?> (<?=$DPaymentDate;?>)</div>
          <?php
              };
          ?>
          <?php
          ...
          ?>
                    <div class="col-md-4 col-xs-4 adding-top10">&nbsp;</div>
                    ...
                    <div class="col-md-4 col-xs-4 padding-top10">&nbsp;</div>
                    <div class="col-md-8 col-xs-4 padding-top10">  <span class="small2">(สอบถามค่าธรรมเนียมและภาษีกับโครงการก่อนวันโอน)</span></div> 
                    <!-end-r1->
                    <div class="clearfix"></div>
                    <br>
                </div>
        ...
        <!-row c->
          <div class="col-md-12 text-grey text-left">
                ...
                <div class="target-rc display-none">
                    ...
                    <div class="col-md-4 col-xs-4"></div><div class="col-md-4"> - ยอดโอนหรือกู้ไม่รวมค่านายหน้า*</div><div class="col-md-4 col-xs-4">฿<?=number_format($rowUnit->DTransferPayment, 0,'',',');?></div>
                    <div class="clearfix">&nbsp;</div>
...
<div class="col-md-12 padding-top1">
  ...
  <div class="bg-grey2"><!-new grey bg->
          ...
          <div class="bg-grey2 col-md-8 resize-mobile">
            <br>
...
?>
            ...
            <div class="text-center text-primary col-md-8 resize-mobile "> 
            ...
            <div class="col-md-8 text-grey bg-grey2 resize-mobile ">
               <br>
      ...
      <div id="map_canvas"></div>
        ...
        <div class="col-md-12 bg-grey2" id="cImgUnits">
