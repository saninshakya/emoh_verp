...
function submitFormPage3()
{
	...
	if (a=="3")
	{
		document.getElementById("ShowStatusPRent").className = "error_msg";
	} else {
		document.getElementById("ShowStatusPRent").className = "normal_msg";
	}

	if (b=="0")
	{
		document.getElementById("ShowPRentPrice2").className = "error_msg";
	} else {
		document.getElementById("ShowPRentPrice2").className = "normal_msg";
	}
	if (c=="99")
	{
		document.getElementById("ShowMinTimePRent").className = "error_msg";
	} else {
		document.getElementById("ShowMinTimePRent").className = "normal_msg";
	}

	if (d=="99")
	{
		document.getElementById("ShowDepositPRent").className = "error_msg";
	} else {
		document.getElementById("ShowDepositPRent").className = "normal_msg";
	}

	if (e=="99")
	{
		document.getElementById("ShowAdvancePRent").className = "error_msg";
	} else {
		document.getElementById("ShowAdvancePRent").className = "normal_msg";
	}
