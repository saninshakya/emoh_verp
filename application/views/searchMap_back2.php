...
<div class="n-container">
        <div class="row">  
          <div class="padding-bottom5 container-fluid">
            ...
            <div class="col-md-4">
               <div class="pull-left w25 border-right">
      ...
      <!--End slider menu -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center">
              ...
              <select class="form-control input-md no-border selectpicker clear-none text-center" data-style="btn-noborder" data-width="200">
...
function displayImgUnits(){
	...
	for(var i=0;i<imgUnits.length;i++){
        ...
        imgNode +=  '<div><div class="unit-show"><div style="padding-left:13px;"><h3> '+imgUnits[i].ProjectName+'</h3></div>';
        imgNode +=  '<div class="bg-grey2" style="position:relative; width:100%; background-color:#87CED5;height:257px;"><img src="'+imgUnits[i].Picture[0]+'" class="t-img-responsive"><h4  class="text-center" style="color:#ffffff; position:absolute; width:160px; bottom:0;right:0; margin-bottom:0; padding-top:8px; background-color: #2190ab; opacity:0.6">ZmyHome เท่านั้น</h4></div></div>';//width="360px" height="172px"
