...
$rowChk=$qPost->row();
$AgreeOwner=$this->post->checkPost('Agree_Owner');
  ...
  <div class="row">
    ...
    <div class="col-md-7 col-md-push-2">
      ...
      <div class="col-md-12 bg-orange">
        <div class="checkbox">
          <p class="text-white big2">ข้าพเจ้า/คนในครอบครัวเป็นเจ้าของทรัพย์สินที่ลงประกาศ</p>
          <label>
      			<input type="checkbox" <?php if ($AgreeOwner==1){echo "checked";}?> value="<?=$AgreeOwner;?>" name="Agree_Owner" id="Agree_Owner" onClick="updateAgreeOwner(this.value);"><p class="text-white big2" id="showAgree_Owner">ยืนยัน</p>
          </label>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-md-4 q-input-line-id">
          ...
          <input name="LineID" id="LineID" class="form-control q-input fade03s <?php if ($this->post->checkPost('TelLineID')==1){echo "display-none";}?>" type="text"  placeholder="ระบุ ID Line" onchange="updatePost('LineID');" value="<?php echo $this->post->checkPost('LineID');?>" <?php if ($this->post->checkPost('TelLineID')==1){echo "disabled";};?> onmouseover="show_title('<?=$qLabel['line_id_title'][0];?>');" onmouseout="hide_title();">
        </div>
      </div>
      <hr>
...
<!--             <div class="row">
            ...
            <div class="row">
              <div class="col-xs-12 col-md-4">
                <div class="q-formtitle" id="ShowTOOwner"><?=$qLabel['owner_type'][0];?></div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class='title-z' id="ShowTOAdvertising"><?=$qLabel['advertising'][0];?></div>
              <select class="form-control input-z" name="TOAdvertising" id="TOAdvertising" onchange="updatePost('TOAdvertising');showDiv()" onmouseover="show_title('<?=$qLabel['advertising_title'][0];?>');" onmouseout="hide_title();">
                <option disabled selected value="0">เลือก</option>
                <?php
               ...
               ?>
                <option value="99">ห้องโครงการ</option>
             </select>
            </div>
            <div class="col-md-8"> 
               <div  class='title-z salerent-info display-none'>*ข้อมูลจำเป็นเพื่อลงประกาศ ขาย/เช่า <br>
                     1. บ้านเลขที่ตามโฉนด/ทะเบียนบ้าน (ข้อมูลปกปิด)<br>
                     2. รูปถ่ายภายในห้องจริงของคุณ
               </div>
               <div  class='title-z resaledown-info display-none'>
                     1. หน้าสัญญาจะซื้อจะขาย แสดงชื้อผู้ซื้อ โครงการ หมายเลขห้อง ราคาและรายละเอียดการผ่อนดาวน์<br>
                     2. รูปจากเว็บโครงการหรือรูปถ่ายห้องตัวอย่าง
               </div>
            </div>
         </div>
          <!--ประเภทอสังหา-->
          <div class="row">
            ...
            <div class="col-xs-12 col-md-4">
              <div class='title-z' id="ShowTOProperty"><?=$qLabel['property_type'][0];?></div>
              <select class="form-control input-z" name="TOProperty" id="TOProperty" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['property_type_title'][0];?>" onchange="updatePost('TOProperty')" onmouseover="show_title('<?=$qLabel['property_type_title'][0];?>');" onmouseout="hide_title();">
                <option disabled selected value="0">เลือก</option>
                <?php
           ...
           <div class="col-xs-12 col-md-8"> 
            <div class="title-z" id="ShowProjectName">ที่อยู่ตามโฉนด (ระบุชื่อโครงการด้วย หากทรัพย์สินอยู่ในโครงการ)<?//=$qLabel['project_name'][0];?></div>
            <input id="ProjectName" Name="ProjectName" class="form-control q-input" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['project_name_title'][0];?>" type="text" <?php if ($ProjectName!=""){echo 'Value="'.$ProjectName.'"';};?> placeholder="เลขที่...." onchange="updateProjectName();" onmouseover="show_title('<?=$qLabel['project_name_title'][0];?>');" onmouseout="hide_title();">
          </div>
        </div>
        <!--end ประเภทอสังหา-->
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4">
              <div class='title-z' id="ShowTOProperty">จังหวัด<?//=$qLabel['property_type'][0];?></div>
              <select class="form-control input-z" name="" id="" data-toggle="tooltip" data-placement="bottom" title="" onchange="updatePost('')" onmouseover="">
                <option disabled selected value="0">เลือก</option>
           ...
           <!--เขต-->
           <div class="col-xs-12 col-md-4">
              <div class='title-z' id="ShowTOProperty">เขต/อำเภอ<?//=$qLabel['property_type'][0];?></div>
              <select class="form-control input-z" name="TOProperty" id="TOProperty" data-toggle="tooltip" data-placement="bottom" title="" onchange="updatePost('')" onmouseover="show_title('');" onmouseout="hide_title();">
                <option disabled selected value="0">เลือก</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-6 col-md-5 col-md-offset-2 col-lg-3 col-lg-push-4">
    <button type="button" class="btn btn-warning col-xs-12" onclick="valLat()" >ถัดไป</button>
  </div>
</div>
<br>
</div>
	...
	<div class="modal modal-sm fade display-none" id="myModalAlert" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content text-center">
				...
				<div class="modal-body row">
					<div id="txt_alert" class="col-md-12 text-center padding-t120 padding-b120"><h4 class="text-grey">คุณยังไม่ได้ระบุประเภทประกาศ</h4></div>
					<div id="modal_submit" class="col-md-12 padding-top10">
