          ...
          <div class="row border-grey2">
            ...
            <div class="col-md-10 bg-blue text-white text-center padding-top2"><input type="hidden" id="otel" value="">
              ...
              <div class="display-none col-md-12 target-b2 text-white text-center">
                  ...
                  <div class="padding-top2"><button type="button" class="btn btn-warning btn-sm" onclick="shareOnFacebook();"><h6><a href="#" onclick="shareOnFacebook();" class"text-white">facebook </a></h6></button>
                  </div>
                  <div id="fb-root"></div>
                  <script>
              ...
              <div class="display-none col-md-12 target-b1 text-white text-center">
                  <div>ดูเบอร์ติดต่อได้ฟรีวันนี้ 1 ครั้่ง</div>
                  <div class="clearfix"></div>
                   <ul class="list-inline">
                    <li><button type="button" class="btn btn-white btn-xs"><h6><a id="up-b1"  href="#" class="text-white">ยกเลิก</a></h6></button></li>
                    <li><button type="button" class="btn btn-warning btn-xs"><h6><a id="down-b2" href="#">ยืนยัน</a></h6></button></li>
                   </ul>
         ...
         $(document).ready(function() {
            ...
            $("#up-r5").click(function(){
              ...
              $("#down-b1").click(function(){
               ...
               /*$("#down-b1").hide( 'fast', function(){});*/
               $("#up-แb1").show( 'fast', function(){});      
            });
