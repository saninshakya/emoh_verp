...
<input type="hidden1" id="post_record" value="0">
<div class="container">
	<div class="row">
		<div class="col-md-7 col-md-push-2">
			...
			<div class="input1">
				...
				<div class="row">
					<div class="col-xs-12 col-md-4">
						...
						<select id="TOProperty" class="form-control selectpicker" name="TOProperty" id="TOProperty" data-toggle="tooltip" data-placement="bottom" data-style="btn-zmyhome" data-width="100%" onchange="checkProperty();">
					...
					<div class="col-xs-12 col-md-8">
						<div id="condo-input" class="display-none">
							<div class="title-z" id="ShowProjectName">ระบุชื่อโครงการ (คอนโดมิเนียม)<?//=$qLabel['project_name'][0];?></div>
							<input id="ProjectName" Name="ProjectName" class="form-control q-input" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['project_name_title'][0];?>" type="text" value="<?php if($ProjectName<>''){echo $ProjectName;}?>" placeholder="โปรดระบุ" onchange="checkPostNew();" onmouseover="show_title('<?=$qLabel['project_name_title'][0];?>');" onmouseout="hide_title();">
						</div>
						<div id="house-input" class="display-none">
							...
							<input id="HouseName" Name="HouseName" class="form-control q-input" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['house_name_title'][0];?>" type="text"  placeholder="โปรดระบุ" onchange="checkPostNew();" onmouseover="" onmouseout="">
						</div>
					</div>
				</div>
				<?php
				...
				<hr>
				<div id="input1_detail" class="display-none">
					<div class="row">
						<div class="col-md-4">
							<div class='q-formtitle' id="ShowTOAdvertising"><?=$qLabel['advertising'][0];?></div>
							<select id="TOAdvertising" class="form-control selectpicker" name="TOAdvertising" data-style="btn-zmyhome" data-width="100%" onchange="updatePost('TOAdvertising');">
								<option disabled selected value="0" class="col-xs-12">เลือก</option>
								...
								<option value="5" class="col-xs-12">ขายและเช่า</option>
								<option value="6" class="col-xs-12">ขายสิทธิการเช่า</option>
							</select>
						</div>
					...
					<div class="row">
						<div class="clearfix"></div>
						<div class="height20 hidden-xs hidden-sm"></div>
						<div class="col-md-12">
					...
					<div class="row">
						<div class="col-xs-12 col-md-4">
							...
							<input name="Telephone1" id="Telephone1" class="form-control q-input" type="tel" placeholder="โปรดระบุ" value="<?php if($Telephone1!=""){echo $Telephone1;}?>" onchange="updatePost('Telephone1')" OnKeyPress="return chkNumber(this);">
						</div>
						<div class="col-xs-12 col-md-4">
			...
			<div class="input2 display-none">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-7 title-z">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="Bedroom" id="Bedroom" onchange="updatePost('Bedroom')" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['bedroom_no_title'][0];?>" onmouseover="show_title('<?=$qLabel['bedroom_no_title'][0];?>');" onmouseout="hide_title();">
							<option selected="true" disabled="disabled" value="0" class="col-xs-12">โปรดเลือก</option>
							<option value="99" class="col-xs-12" <?php if ($this->post->checkPost('Bedroom')==99){echo "selected";};?>>สตูดิโอ</option>
							<?php
							$i=1;
							while ($i<=7){
							?>
								<option class="col-xs-12" value="<?echo $i;?>" <?php if ($this->post->checkPost('Bedroom')==$i){echo "selected";};?>><?echo $i;?> ห้องนอน</option>
							<?php
								$i=$i+0.5;
							}
							?>
					...
					<div class="col-md-4 col-sm-7 title-z">
						...
						<select class="form-control selectpicker text-grey" name="Bathroom" id="Bathroom" onchange="updatePost('Bathroom')" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['bathroom_no_title'][0];?>" onmouseover="show_title('<?=$qLabel['bathroom_no_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" selected="true" disabled="disabled" value="0">โปรดเลือก</option>
							<?php
							$i=1;
							while ($i<=10){
							?>
								<option class="col-xs-12" value="<?echo $i;?>" <?php if ($this->post->checkPost('Bathroom')==$i){echo "selected";};?>><?echo $i;?> ห้องน้ำ</option>
							<?php
								$i=$i+0.5;
							}
							?> 
				...
				<div class="row">
					<div class="col-md-4 col-sm-7 title-z">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="Direction" id="Direction" onchange="updatePost('Direction')" onmouseover="show_title('<?=$qLabel['direction_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" selected="true" disabled="disabled" value="0">โปรดเลือก</option>
							<?php
							$query=$this->post->direction();
							foreach ($query->result() as $row){
							?>
								<option class="col-xs-12" value="<?echo $row->DID;?>" <?php if ($this->post->checkPost('Direction')==$row->DID){echo "selected";};?>><?echo $row->DName;?></option>
							<?php
							}
							?>
						</select>               
				...
				<div class="row">
					<div class="col-md-4 col-sm-7">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="NCarPark" id="NCarPark"  onchange="updatePost('NCarPark')" onmouseover="show_title('<?=$qLabel['ocarpark_nofixed_title'][0];?>');" onmouseout="hide_title();">
							<option selected="true" value="0" class="col-xs-12">โปรดเลือก</option>
							<?php
							$i=1;
							while ($i<=5){
							?>
								<option class="col-xs-12" value="<?echo $i;?>" <?php if ($this->post->checkPost('NCarPark')==$i){echo "selected";};?>>ไม่ระบุช่องจอด <?php if($i!=0){echo $i;};?>คัน</option>
								<?php
								$i++;
							}
							?>
					...
					<div class="col-md-4 col-sm-7">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="ACarPark" id="ACarPark" onchange="updatePost('ACarPark')" onmouseover="show_title('<?=$qLabel['ocarpark_fixed_title'][0];?>');" onmouseout="hide_title();">
							<option selected="true" value="0" class="col-xs-12">โปรดเลือก</option>
							<?php
							$i=1;
							while ($i<=5){
							?>
								<option class="col-xs-12" value="<?echo $i;?>" <?php if ($this->post->checkPost('ACarPark')==$i){echo "selected";};?>>ระบุช่องจอด <?php if($i!=0){echo $i;};?>คัน</option>
							<?php
								$i++;
							}
							?>
					...
					<div class="col-md-4 col-sm-7">
						...
						<select class="form-control is-disabled selectpicker" data-style="btn-zmyhome" data-width="100%" name="OCarPark" id="OCarPark" onchange="updatePost('OCarPark')" data-toggle="tooltip" data-placement="bottom" onmouseover="show_title('<?=$qLabel['ocarpark_certificate_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" selected="true" value=0>โปรดเลือก</option>
							<?php
							$i=1;
							while ($i<=5){
							?>
								<option class="col-xs-12" value="<?echo $i;?>" <?php if ($this->post->checkPost('OCarPark')==$i){echo "selected";};?>>มีโฉนดที่จอดรถ <?php if($i!=0){echo $i;};?>คัน</option>
							<?php
								$i++;
							}
							?>
				...
				<div class="row">
					<div class="col-md-4"><h5><?=$qLabel['special_features'][0];?></h5></div>
				</div>
				<div class="row">
			...
			<div class="input3 input31 display-none">
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="AgreePostDay" id="AgreePostDay" onchange="updatePost('AgreePostDay')" onmouseover="show_title('<?=$qLabel['agreepostday_title'][0];?>');" onmouseout="hide_title();">
							<?php
							$i=30;
							while ($i<=180){
							?>
								<option class="col-xs-12" value="<?php echo $i;?>" <?php if ($AgreePostDay==$i){echo "selected";};?>><?php echo $i;?>วัน</option>
								<?php
								$i=$i+30;
							}
							?>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="StatusPRent" id="StatusPRent" onchange="updatePost('StatusPRent');enableForm();" onmouseover="show_title('<?=$qLabel['residence_status_now_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled selected value="3">ว่าง/มีผู้เช่า</option>
							<option class="col-xs-12" value="0" <?php if ($this->post->checkPost('StatusPRent')==0){echo "selected";};?>>ว่าง</option>
							<option class="col-xs-12" value="1" <?php if ($this->post->checkPost('StatusPRent')==1){echo "selected";};?>>มีผู้เช่า</option>
						</select>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="PRentNational" id="PRentNational" onchange="updatePost('PRentNational');" onmouseover="show_title('<?=$qLabel['residence_detail_rent_nation_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled selected>ระบุสัญชาติผู้เช่ากรณีมีผู้เช่าอยู่</option>
							<?php
							...
							foreach ($query->result() as $row){
								...
								$name=$row->Name_th;
							?>
								<option class="col-xs-12" value="<?php echo $i;?>" <?php if ($this->post->checkPost('PRentNational')==$i){echo "selected";};?>><?php echo $name;?></option>
								<?php
							}
							?>
						</select>
			...
			<div id="input32" class="input32 display-none">
				...
				<div class="row">
					...
					<h5 id="showAgreePostDay9" class="margin-bottom-clear-pc"><?=$qLabel['agreepostday'][0];?><a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="ไม่ขึ้นราคาเมื่อมีผู้โทรมาสอบถาม" ><span class="glyphicon glyphicon-info-sign text-turq2 input-sm  padding-clear" aria-hidden="true"></span></a></h5>
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="AgreePostDay" id="AgreePostDay" onchange="updatePost('AgreePostDay')" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['agreepostday_title'][0];?>" onmouseover="show_title('<?=$qLabel['agreepostday_title'][0];?>');" onmouseout="hide_title();">
						<option class="col-xs-12" value=0 disabled selected>โปรดเลือก</option>
						<?php
						$i=30;
						while ($i<=180){
						?>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="PrefixDProfitPrice" id="PrefixDProfitPrice" onchange="updatePost('PrefixDProfitPrice');calDTotalPrice();" onmouseover="show_title('<?=$qLabel['dprofitprice_prefix_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" value="3" disabled selected>โปรดเลือก</option>
							<option class="col-xs-12" value="1" <?php if ($this->post->checkPost('PrefixDProfitPrice')==1){echo "selected";};?>>ต้องการกำไร</option>
							<option class="col-xs-12" value="0" <?php if ($this->post->checkPost('PrefixDProfitPrice')==0){echo "selected";};?>>ยอมขาดทุน</option>
							<option class="col-xs-12" value="2" <?php if ($this->post->checkPost('PrefixDProfitPrice')==2){echo "selected";};?>>ขายเท่าทุน</option>
						</select>
					</div>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="col-md-12 padding-left-clear title-z"><span class="text-primary">ราคาขายสุทธิ  ________บาท </span></div>
						<div class="col-md-12 padding-left-clear title-z"><span class="text-primary">ราคายายดาวน์ ________บาท </span> </div>
					</div>
				</div>    
				<br>
				<hr/>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="DFreeFeeMember" id="DFreeFeeMember" onchange="updatePost('DFreeFeeMember');">
							<?php
							$i=0;
							while ($i<=10){
							?>
								<option class="col-xs-12" value="<?php echo $i;?>" <?php if ($this->post->checkPost('DFreeFeeMember')==$i){echo "selected";};?>><?php echo $i;?>ปี</option>
							<?php
								$i++;
							}
							?>
			...
			<div class="input35 display-none">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="MinTimePRent" id="MinTimePRent" onchange="updatePost('MinTimePRent');" onmouseover="show_title('<?=$qLabel['residence_detail_rent_mintime_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled="disabled" selected="selected" value="99">โปรดเลือก</option>
							<option class="col-xs-12" value="1" <?php if ($this->post->checkPost('MinTimePRent')=="1"){echo "selected";};?>>1 เดือน</option>
							<option class="col-xs-12" value="2" <?php if ($this->post->checkPost('MinTimePRent')=="2"){echo "selected";};?>>2 เดือน</option>
							<option class="col-xs-12" value="3" <?php if ($this->post->checkPost('MinTimePRent')=="3"){echo "selected";};?>>3 เดือน</option>
							<option class="col-xs-12" value="6" <?php if ($this->post->checkPost('MinTimePRent')=="6"){echo "selected";};?>>6 เดือน</option>
							<option class="col-xs-12" value="12" <?php if ($this->post->checkPost('MinTimePRent')=="12"){echo "selected";};?>>1 ปี</option>
						</select>
					</div>
					<div class="col-md-4">
						<div class="title-z normal_msg" id="ShowDepositPRent"><h5><?=$qLabel['residence_detail_rent_pledge'][0];?></h5></div>
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="DepositPRent" id="DepositPRent" onchange="updatePost('DepositPRent');" onmouseover="show_title('<?=$qLabel['residence_detail_rent_pledge_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled="disabled" selected="selected" value="99">โปรดเลือก</option>
							<option class="col-xs-12" value="1" <?php if ($this->post->checkPost('DepositPRent')=="1"){echo "selected";};?>>1เดือน</option>
							<option class="col-xs-12" value="2" <?php if ($this->post->checkPost('DepositPRent')=="2"){echo "selected";};?>>2เดือน</option>
							<option class="col-xs-12" value="3" <?php if ($this->post->checkPost('DepositPRent')=="3"){echo "selected";};?>>3เดือน</option>
						</select>
					</div>
					<br class="visible-xs visible-sm">
					<div class="col-md-4">
						<div class="title-z normal_msg" id="ShowAdvancePRent"><h5><?=$qLabel['residence_detail_rent_advance'][0];?></h5></div>
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="AdvancePRent" id="AdvancePRent" onchange="updatePost('AdvancePRent');" onmouseover="show_title('<?=$qLabel['residence_detail_rent_advance_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled="disabled" selected="selected" value="99">โปรดเลือก</option>
							<option class="col-xs-12" value="1" <?php if ($this->post->checkPost('AdvancePRent')=="1"){echo "selected";};?>>1เดือน</option>
							<option class="col-xs-12" value="2" <?php if ($this->post->checkPost('AdvancePRent')=="2"){echo "selected";};?>>2เดือน</option>
							<option class="col-xs-12" value="3" <?php if ($this->post->checkPost('AdvancePRent')=="3"){echo "selected";};?>>3เดือน</option>            
						</select>
					</div>
				</div>
				<!--End Edit-->
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="StatusPRent" id="StatusPRent" onchange="updatePost('StatusPRent');enableForm();" onmouseover="show_title('<?=$qLabel['residence_status_now_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled selected value="3">ว่าง/มีผู้เช่า</option>
							<option class="col-xs-12" value="0" <?php if ($this->post->checkPost('StatusPRent')==0){echo "selected";};?>>ว่าง</option>
							<option onchange="rentalstatus();"  class="col-xs-12" value="1" <?php if ($this->post->checkPost('StatusPRent')==1){echo "selected";};?>>มีผู้เช่า</option>
						</select>
					</div>
					<div class="col-md-4">
						<div class="title-z  rentalstatus-chk"><h5><?=$qLabel['residence_detail_rent_nation'][0];?></h5></div>
						<select class="form-control selectpicker  rentalstatus-chk" data-style="btn-zmyhome" data-width="100%" name="PRentNational" id="PRentNational" onchange="updatePost('PRentNational');" onmouseover="show_title('<?=$qLabel['residence_detail_rent_nation_title'][0];?>');" onmouseout="hide_title();">
							<option class="col-xs-12" disabled selected>ระบุสัญชาติผู้เช่ากรณีมีผู้เช่าอยู่</option>
							<?php
							$query=$this->post->qRentNational();
							foreach ($query->result() as $row){
					...
					<div class="col-md-4">
						<div class="title-z  rentalstatus-chk"><h5><?=$qLabel['residence_detail_rent_end'][0];?></h5></div>
						<input class="form-control input-z  rentalstatus-chk" type="text" name="PRentEnd" id="PRentEnd" data-date-format="yyyy-mm-dd" onblur="setTimeout(function(){updatePost('PRentEnd')}, 500);" value="<?php echo $this->post->checkPost('PRentEnd');?>" <?php if ($this->post->checkPost('StatusPRent')==0){echo "disabled";};?> onmouseover="show_title('<?=$qLabel['residence_detail_rent_end_title'][0];?>');" onmouseout="hide_title();">
					</div>
				</div>
				<hr>
				<div class="row">
				...
				<div class="row">
					<div class="col-xs-6 col-md-5 col-lg-3">
						<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInput21()">ก่อนหน้า</button>
					</div> 
					<div class="col-xs-6 col-md-5 col-md-push-2 col-lg-3 col-lg-push-6">
						<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInput41()">ถัดไป</button>
					</div>
				</div>
				<br>
			</div>
			...
			<!--input36-->
			<div class="input36  display-none">
				<h3 class="text-primary">ตั้งราคาเซ้งสิทธิการเช่า</h3>
				<div class="checkbox">
					<p class="text-primary">เพื่อป้องกันความสับสน ราคาที่ประกาศให้ผู้ขายรวมค่าใช้จ่ายทุกอย่างแล้ว <small class="text-primary">ยกเว้นค่าจดจํานอง</small></p>
					<p class="text-grey">
						1. ปรับราคาประกาศขาย เพื่อให้ได้ราคาสุทธิที่ท่านต้องการ<br/>
		    ...
		    <div class="inputhome2 display-none">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-7">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="Bedroom" id="Bedroom" onchange="" data-toggle="tooltip" data-placement="bottom" title="" onmouseover="" onmouseout="hide_title();">
							<option class="col-xs-12" selected="true" disabled="disabled" value="0">โปรดเลือก</option>
							<option class="col-xs-12" value="99" selected>สตูดิโอ</option>
							<option class="col-xs-12" value="1" >1 ห้องนอน</option>
							<option class="col-xs-12" value="1.5" >1.5 ห้องนอน</option>
							<option class="col-xs-12" value="2" >2 ห้องนอน</option>
							<option class="col-xs-12" value="2.5" >2.5 ห้องนอน</option>
							<option class="col-xs-12" value="3" >3 ห้องนอน</option>
							<option class="col-xs-12" value="3.5" >3.5 ห้องนอน</option>
							<option class="col-xs-12" value="4" >4 ห้องนอน</option>
							<option class="col-xs-12" value="4.5" >4.5 ห้องนอน</option>
							<option class="col-xs-12" value="5" >5 ห้องนอน</option>
							<option class="col-xs-12" value="5.5" >5.5 ห้องนอน</option>
							<option class="col-xs-12" value="6" >6 ห้องนอน</option>
							<option class="col-xs-12" value="6.5" >6.5 ห้องนอน</option>
							<option class="col-xs-12" value="7" >7 ห้องนอน</option>
						</select>
					</div>
					<div class="col-md-4 col-sm-7">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="Bathroom" id="Bathroom" onchange="updatePost('Bathroom')" data-toggle="tooltip" data-placement="bottom" title="ห้องน้ำที่ไม่มีส่วนอาบน้ำ ให้นับเป็น 0.5 ห้อง" onmouseover="show_title('ห้องน้ำที่ไม่มีส่วนอาบน้ำ ให้นับเป็น 0.5 ห้อง');" onmouseout="hide_title();">
							<option class="col-xs-12" selected="true" disabled="disabled" value="0">โปรดเลือก</option>
							<option class="col-xs-12" value="1" selected>1 ห้องน้ำ</option>
							<option class="col-xs-12" value="1.5" >1.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="2" >2 ห้องน้ำ</option>
							<option class="col-xs-12" value="2.5" >2.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="3" >3 ห้องน้ำ</option>
							<option class="col-xs-12" value="3.5" >3.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="4" >4 ห้องน้ำ</option>
							<option class="col-xs-12" value="4.5" >4.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="5" >5 ห้องน้ำ</option>
							<option class="col-xs-12" value="5.5" >5.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="6" >6 ห้องน้ำ</option>
							<option class="col-xs-12" value="6.5" >6.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="7" >7 ห้องน้ำ</option>
							<option class="col-xs-12" value="7.5" >7.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="8" >8 ห้องน้ำ</option>
							<option class="col-xs-12" value="8.5" >8.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="9" >9 ห้องน้ำ</option>
							<option class="col-xs-12" value="9.5" >9.5 ห้องน้ำ</option>
							<option class="col-xs-12" value="10" >10 ห้องน้ำ</option>
						</select>
					</div>
				</div>
				<br>
				<div class="row">
					<div class="col-md-4 col-sm-7">
						...
						<select class="form-control selectpicker" data-style="btn-zmyhome" data-width="100%" name="Direction" id="Direction" onchange="updatePost('Direction')" onmouseover="show_title('ระบุทิศให้ถูกต้อง เพราะมีผลต่อการพิจารณาของผู้ซื้ออย่างมาก');" onmouseout="hide_title();">
							<option class="col-xs-12" selected="true" disabled="disabled" value="0">โปรดเลือก</option>
							<option class="col-xs-12" value="1" >ทิศตะวันออก</option>
							<option class="col-xs-12" value="2" >ทิศตะวันออกเฉียงเหนือ</option>
							<option class="col-xs-12" value="3" >ทิศตะวันออกเฉียงใต้</option>
							<option class="col-xs-12" value="4" >ทิศเหนือ</option>
							<option class="col-xs-12" value="6" >ทิศใต้</option>
							<option class="col-xs-12" value="7" >ทิศตะวันตกเฉียงเหนือ</option>
							<option class="col-xs-12" value="8" >ทิศตะวันตกเฉียงใต้</option>
							<option class="col-xs-12" value="9" >ทิศตะวันตก</option>
						</select>
					</div>
					<div class="col-md-4 col-sm-7">
				...
				<div class="row">
					<div class="col-md-12">
						<h5>ข้อมูลอื่นๆ (ห้ามกรอก ชื่อ เบอร์โทร อีเมลล์ LineID FB ในช่องข้างล่างนี้ กรุณาระบุในพื้นที่ที่จัดให้เท่านั้น)</h5>
					</div>
				</div>
				<div class="row">
			...
			<div class="inputhome3 display-none">
				...
				<div class="col-md-12 padding-none">
					<ul class="list-inline">
						<li class="col-md-4">
							<div class="checkbox padding-pro2 table-bordered">
								<label>
									<input type="checkbox"  name="" id="salewithtenant" onclick="salewithtenant() "><h5 class="margin-top-clear padding-t2">ขายพร้่อมผู้เช่า</h5>
								</label>
							</div>
						</li>
					</ul>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="title-z salewithtenant-chk display-none">วันสิ้นสุดสัญญา</div>
						<input class="form-control input-z display-none salewithtenant-chk" type="text" name="PRentEnd" id="PRentEnd">
					</div>
				</div>	   
				<hr>
				<div class="clearfix"></div>
