...
?>
										<div class="col-xs-12 clear-margin-padding-mobile  visible-sm visible-xs">
												<button type="button" class="btn btn-green2 cursor input-z col-xs-12" onclick="showBoostPost('<?=$POID;?>')"><h5 class="text-white padding-none">Boost Post</h5></button>
										</div>
<?php
	}
	if ($checkStatus==4){
...
?>
                    ...
                    <div class="col-xs-12 clear-margin-padding-mobile  visible-sm visible-xs">
                        <button type="button" class="btn btn-warning cursor input-z col-xs-12" onclick="showBoostPost('<?=$POID;?>')">
...
?>
              ...
              <div id="dash-list2" class="col-md-4 col-xs-6 padding-lr0 hidden-xs hidden-sm">
               ...
               <div class="col-md-4 padding-none  hidden-xs">
                        <button type="button" class="btn btn-blue cursor  hidden-xs hidden-sm" onclick="showBoostPost(<?=$POID;?>)">Boost Post</button>
               </div>
               <!--new aug 17-->
