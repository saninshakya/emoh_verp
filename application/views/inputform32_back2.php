...
<div class="container">
        <div class="row">
            ...
            <div class="col-md-7 col-md-push-2">
              <h3 class="text-primary">ตั้งราคาขายดาวน์</h3>
                <p class="text-primary big2">การขายดาวน์ต้องบอกรายละเอียดการผ่อนชำระ และค่าใช้จ่ายตามสัญญาให้ครบถ้วน</p>
              <hr>
              <div class="row">
       ...
       <div class="row">
			...
			<div class="row">
               <div class="col-md-8">
                 <h5 id="showDNetPrice9">ราคาหน้าสัญญา/ใบจอง(บาท) * <a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="หักส่วนลดแล้ว" > <span class="glyphicon glyphicon-info-sign text-turq2 input-sm" aria-hidden="true"></span></a></h5>
               ...
               <div class="col-md-4">
                <h5 id="showAgreePostDay9">ยืนยันราคาขาย(วัน)<a class="tip" href="#" data-toggle="tooltip" data-placement="top" data-original-title="ไม่ขึ้นราคาเมื่อมีผู้โทรมาสอบถาม" > *  <span class="glyphicon glyphicon-info-sign text-turq2 input-sm" aria-hidden="true"></span></a></h5>
            ...
            <div class="row">
               <div class="col-md-4">
                 <h5>ค่าธรรมเนียมการเปลี่ยนสัญญา</h5>
               ...
               <div class="col-md-7 padding-top8">
          ...
          <div class="clearfix"></div><br>
				  <div class="col-md-12">
				      <h5 id="showDAllPayment9">รวมจอง ทำสัญญา ดาวน์(บาท)</h5>
          </div>
          <br>
          <div class="col-md-4">
      ...
      <br>
			<div class="row">
                  <div class="col-md-4">
                   <h5 id="showDReadyPayment9">ชำระแล้ว(บาท)</h5>
                   <input class="form-control input-md" type="text" name="showDReadyPayment" id="showDReadyPayment" value="฿<?php echo number_format($this->post->checkPost('DReadyPayment'),0,'.',',');?>" onclick="this.value=document.getElementById('DReadyPayment').value" onchange="changeFormat('showDReadyPayment','DReadyPayment');setTimeout(function(){calDDownTotalPrice()}, 100);" OnKeyPress="return chkNumber(this)">
                  </div>
				          <div class="col-md-4">
      ...
      <br>
			<div class="row">
				   <div class="col-md-4">
                   <h5 id="showDStalePaymentMonth9">ผ่อนดาวน์อีก(งวด)</h5>
            ...
            <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="checkbox table-bordered padding-pro2">
                     ...
                     <div style="padding-top:7px"><h5>ส่วนลด (บาท)</h5></div>
