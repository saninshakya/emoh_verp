...
<div class="home-photo">
    <div class="col-md-12 slogan-word home">
      ...
      <div class="text-center"><span class="slogan-text2" id="sMsg">แนวคิดใหม่ของตลาดบ้านและคอนโด เพื่อคนไทย</span></div>
     <br>
    </div>
    ...
    <div class="ad-box text-center">
      ...
      <div class="col-md-10 text-center">
       <span class="text-turq2">ลงประกาศด่วน!</span> ก่อนเปิดตัว 1 ต.ค. รับสิทธิขายหรือเช่า <span class="text-turq2">ฟรี1ปี!</span></div>
      </div>
      <div class="col-md-1"></div>
    </div>  
    <!end ad text->
...
<div class="col-md-12 text-center home">
    ...
    <div class="row padding-top1">
	  <div class="white-box center-block text-center"><a href="/zhome/howItWork" class="post-text2">How we work? </a></div><br>
    ...
    <div class="col-md-8">
          ...
          <div class="col-md-4">
            ...
            <h3 class="text-grey font-responsive">
                ...
                <div class="padding-top1">ที่มีประโยชน์บน ZHome</div><br><br>
