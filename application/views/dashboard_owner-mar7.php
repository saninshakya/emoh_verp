...
?>         
		  ...
		  <div class="row hidden-xs hidden-sm">
              <div class="col-md-12 clear-margin-padding padding-l10-m"> <h3 class="text-primary">ไม่มีประกาศ</h3>
               <hr class="clear-margin-padding">
              </div>
           </div>
           <div class="row visible-xs visible-sm">
              <div class="col-md-12 clear-margin-padding padding-l15"> <h3 class="text-primary">ไม่มีประกาศ</h3>
               <hr class="clear-margin-padding">
              </div>
           </div> 
<?php
...
?>
           <div class="row hidden-xs hidden-sm">
              <div class="col-md-12 clear-margin-padding padding-l10-m"> <h3 class="text-primary">ประกาศ</h3>
               <hr class="clear-margin-padding">
              </div>
           </div>
           <div class="row visible-xs visible-sm">
              <div class="col-md-12 clear-margin-padding padding-l15"> <h3 class="text-primary">ประกาศ</h3>
               <hr class="clear-margin-padding">
              </div>
           </div> 
...
<?php
	...
	foreach ($ListPostType1->result() as $row){
		...
		if($row->Bedroom=="99"){
			...
			$Bedroom=$row->Bedroom." ห้องนอน";
			$Bedroom_mb=$row->Bedroom." นอน";
		}
		$Bathroom=$row->Bathroom." ห้องน้ำ";
...
?>
            ...
            <div class="row">
              ...
              <div class="col-md-4 text-shadow2 bg-responsive" onclick="window.open('/zhome/unitDetailOwner/<?=$row->POID;?>', '_blank')" style="background-image: linear-gradient(rgba(255,255,255,0.3),rgba(51,51,51,0.3)), url('<?=$this->dashboard->imageList($row->POID);?>');">
                 <!--Mobile-->
              ...
              <!--mobile bt-->
               <div class="visible-xs visible-sm col-xs-12 clear-margin-padding">
					...
					<div class="col-xs-6 clear-margin-padding-mobile visible-xs">
					<?php
	                if ($Active==93){
					?>
						<button type="button" class="btn btn-orange3" data-toggle="modal" data-target="#ShowMobileNumber" onclick="$('#modal_token').val('<?=$Token;?>');">ยกเลิกซ่อนเบอร์โทร</button>
					<?}else{?>
						<button type="button" class="btn btn-orange3" data-toggle="modal" data-target="#HideMobileNumber" onclick="$('#modal_token').val('<?=$Token;?>');">ซ่อนเบอร์โทร</button>
					<?}?>
					 </div>
	                 <div class="col-xs-6 clear-margin-padding-mobile visible-xs">
		                <?php
							if ($Active!=81){
						?>
							<button type="button" class="btn btn-orange3"  data-toggle="modal" data-target="#InformSold">
							<span onclick="$('#modal_token').val('<?=$Token;?>');">แจ้ง ขาย/เช่าได้แล้ว </span>
						<?php
							} else {
						?>
							<button type="button" class="btn btn-orange3">
	                 ...
	                 <br>
						...
						<?php 
							if ($NumExpire<30){
						?>
								<button type="button" class="btn btn-green3">
								<span onclick="location.href='/zhome/AddDateExpire/<?=$Token?>/60'"><?=$txt_expire;?> ต่ออายุ 2 เดือนฟรี</span>
						<?php
							}else{
						?>
								<button type="button" class="btn btn-green3" data-toggle="modal" data-target="#ExpandTime" onclick="$('#modal_numexpire').val('<?=$NumExpire;?>');$('#modal_dateexpire').val('<?=$DateExpire;?>');$('#modal_token').val('<?=$Token;?>');sendModalExpire();"><?=$txt_expire;?>
						<?
							}
						} else if ($Active==81){
						?>
							<button type="button" class="btn btn-green3" disabled>
	           		 ...
	           		 <div class="col-xs-6 clear-margin-padding-mobile visible-xs"><button type="button" class="btn btn-green3" onclick="location.href='/zhome/EditPost2/<?=$Token?>'">แก้ไขประกาศ</button>
	                 </div>  
	             </div>  
              <!--end mobile bt-->
...
?>
         ...
         <div class="row hidden-xs hidden-sm">
              <div class="col-md-12 clear-margin-padding padding-l10-m"> <h3 class="text-primary">รอประกาศ</h3>
               <hr class="clear-margin-padding">
              </div>
           </div>
           <div class="row visible-xs visible-sm">
              <div class="col-md-12 clear-margin-padding padding-l15"> <h3 class="text-primary">รอประกาศ</h3>
               <hr class="clear-margin-padding">
              </div>
           </div> 
...
?>
     ...
     <div class="row">
              ...
              <div class="col-md-4 col-xs-12 text-shadow2 bg-responsive" onclick="window.open('/zhome/unitDetailOwner/<?=$row->POID;?>', '_blank')" style="background-image: linear-gradient(rgba(255,255,255,0.3),rgba(51,51,51,0.3)), url('<?=$this->dashboard->imageList($row->POID);?>');">
                 <!--Mobile-->
                 <div class="visible-xs visible-sm">
