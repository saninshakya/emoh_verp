  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav navbar-right padding-none visible-xs visible-sm w50 pull-right">
        <li class="btn-p2 pull-right"><a href="/auth/login2/" class="btn-p2 btn-prakard">ลงประกาศฟรี</a></li>
      </ul>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <span class="navbar-brand-menu"><a href="/auth/login2/" class="text-white">Sign Up</a>&nbsp;<span class="text-white">|</span>&nbsp;<a href="/auth/login/" class="text-white">Log In</a></span>

   <ul class="nav navbar-nav navbar-right padding-none">
        <li class="btn-p2 pull-right hidden-xs hidden-sm"><a href="/auth/login2/" class="btn-prakard">ลงประกาศฟรี</a></li>
