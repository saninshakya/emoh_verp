...
<div class="container">
          ...
          <div class="row border-grey2">
            ...
            <div class="col-md-12 bg-box-grey">
               <div class="col-md-12"">
                ...
                <div class="col-xs-1 text-white padding-clear text-left">
                   
                     <div><h6>นอน</h6></div>
                     <div class="h7 text-right">
                     <?php
               ...
               <div class="col-xs-2 text-white padding-clear">
                    <div class="border-left padding-l7"><h6>น้ำ</h6></div>
                    <div class="border-left padding-l7 h7"><?=$rowUnit->Bathroom;?></div>
                    
                </div>

               

                <div class="col-xs-3 text-white padding-clear">
                    <div class="text-right border-right padding-r8"><h6>ตร.ม</h6></div>
                    <div class="h7 text-right border-right padding-r8"> <?=$sumArea;?></div>
                </div>
                <div class="col-xs-3 text-white padding-clear">
                     <div class="padding-l1 margin-l2"><h6>ตร.ว</h6></div>
                     <div class="h7 padding-l1 margin-l2">--</div>
                </div>
             
                <div class="col-xs-2 text-white padding-clear text-right">
                    <div class="margin-r9"><h6>ทิศ</h6></div>

                     <div class="h7 margin-r9"><?=$Direction;?></div>
                </div>
                <div class="col-xs-1 text-white padding-clear border-left">
                    <div class="margin-left4"><h6>ชั้น</h6></div>

                    <div class="h7 margin-left4"><?=$rowUnit->Floor;?></div>
                </div>
            ...
            <div class="col-md-10 bg-blue text-white text-center padding-top2">
             ...
             <div class="col-md-1"></div> 
             <div class="col-md-12 text-center padding-top1"><div class="text-primary">แจ้ง! : <a class="text-primary" href="#"> ไม่ใช่เจ้าของ</a> <a class="text-primary" style="padding-left:7px;" href="#">  ขายแล้ว</a> <a class="text-primary" href="#" style="padding-left:7px;">  ขึ้นราคา</a> <a class="text-primary" href="#" style="padding-left:7px;">  ข้อมูลผิด</a> <a class="text-primary" href="#" style="padding-left:7px;">  อื่นๆ</a></div></div>
        ...
        <div class="col-md-8 col-md-pull-4">
          ...
          <div class="col-md-12 bg-grey2">
            ...
            <div class="col-md-12">
              <div class="col-md-4 col-xs-4">
                <div class="text-grey text-left"><?php if (isset($getCondoSpec1[0])){echo $getCondoSpec1[0];} else {echo "&nbsp;";};?></div>
              </div>
              <div class="col-md-4 col-xs-4 text-center border-left">
                 <div class="text-grey text-left"><?php if (isset($getCondoSpec2[0])){echo $getCondoSpec2[0];} else {echo "&nbsp;";};?></div> 
              </div>
              <div class="col-md-4 col-xs-4 text-center border-left">
                 <div class="text-grey text-left"><?php if (isset($getCondoSpec3[0])){echo $getCondoSpec3[0];} else {echo "&nbsp;";};?></div>
              </div>
            </div>
            <!-end row2->
            <!-hide data2-->
      ...
      ?>
        ...
        <div class="text-grey">
          ...
          <div class="col-md-12 text-grey text-left">
                <div class="col-md-4">
                 <h5 class="text-primary">ราคา ค่าธรรมเนียม และโปรโมชั่น</h5>
                </div>
                <div class="col-md-4">
        ...
        <!-row c->
          <div class="col-md-12 text-grey text-left">
                <div class="col-md-4">
                   <h5 class="text-primary">สินเชื่อ</h5>
                </div>
...
?>
            ...
            <!-- hide detail ---->
            <div class="col-md-12 text-grey target-r5 display-none padding-top6">
               <div class="col-md-4 col-xs-4">
			   	<?php 
					if ($project!=null){
			   ?>
