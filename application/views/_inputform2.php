...
<div class="container">
        <div class="row">
          ...
          <div class="col-md-7 col-md-push-2">
            ...
            <div class="checkbox">
                <p class="text-primary">ระบุข้อมูลให้ถูกต้อง หากไม่แน่ใจ ให้ตรวจสอบโฉนดหรือเอกสารโครงการ</p>
            </div>
            <hr>
            ...
            <div class="row">
               <div class="col-md-4 col-sm-6">
                 ...
                 <div class="checkbox bg-info padding-pro">
                   <label>
                     <input type="checkbox" value="<?php echo $row->TOCSID;?>" onClick="updateCondoSpec(this.value)" <?php echo $this->post->checkCondoSpec($row->TOCSID);?>><p class="text-blue"><?php echo $row->CSName_th;?></p>
                   </label>
                  </div>
				 <?php
					}
