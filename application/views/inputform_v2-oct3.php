...
<div class="container">
	<div class="row">
		<div class="col-md-7 col-md-push-2">
          ...
          <div class="row">
             <div class="col-md-4">
              ...
              <select id="ShowType" class="form-control q-input" name="TOAdvertising" onmouseover="show_title('<?=$qLabel['advertising_title'][0];?>');" onmouseout="hide_title();">
                <option disabled selected value="0">เลือก</option>
                <option value="1">ขาย</option>
                <option value="2">ขายดาวน์</option>
                <option value="3">เช่า</option>
                <option value="4">ขายสิทธิการเช่า</option>
             </select>
           </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-4">
              ...
              <select id="house-types" class="form-control q-input" name="TOProperty" id="TOProperty" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['property_type_title'][0];?>" onchange="updatePost('TOProperty')" onmouseover="show_title('<?=$qLabel['property_type_title'][0];?>');" onmouseout="hide_title();">
                  <option disabled selected value="0">เลือก</option>
                  <option value="1">คอนโดมิเนี่ยม</option>
                  <option value="2">บ้านเดี่ยว</option>
                  <option value="3">บ้านแฝด</option>
                  <option value="4">ทาวน์เฮาส์</option>
                  <option value="5">ตึกแถว</option>
                  <!--<?php
        ...
        <div class="row">
            <div class="col-xs-12 col-md-4">
              ...
              <select id="" class="form-control z-input">
                  <option disabled selected value="0">เลือก</option>
    ...
    <!--end input2-->
		...
		<!--input32-->
		<div class="input32 display-none">
		...
		<div class="input35 display-none">
				...
				<div class="col-xs-12">
					...
					<div class="checkbox ">
						<label class="col-xs-12 radio-inline">
							<input type="checkbox"><span class="text-grey"> ตกลง&nbsp;&nbsp;&nbsp;&nbsp;</span><span>บริษัท/นิติบุคคล จะมีการหักภาษีณที่จ่ายจากค่าใช้จ่ายบริษัท</span>
						</label>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="checkbox ">
						<label class="col-xs-12 radio-inline">
							<input type="checkbox"><span class="text-grey"> ตกลง&nbsp;&nbsp;&nbsp;&nbsp;</span><span>ค่าบริการ 1 เดือน ต่อสัญญา 1 ปี</span>
						</label>
		...
		<div class="input5 display-none">
          ...
          &nbsp;
            ...
            <div class="row">
				<div class="col-xs-6 col-md-5 col-lg-3">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInput4back()">ก่อนหน้า</button>
				</div> 
				<div class="col-xs-6 col-md-5 col-md-push-2 col-lg-3 col-lg-push-6">
...
<!--input home-->
       ...
       <!--inputhome2-->
            ...
            <div class="row">
				<div class="col-xs-6 col-md-5 col-lg-3">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInputHome1()">ก่อนหน้า</button>
				</div> 
				<div class="col-xs-6 col-md-5 col-md-push-2 col-lg-3 col-lg-push-6">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInputHome3()">ถัดไป</button>
				</div>
			</div>
			<br>
		</div>
		...
		<div class="inputhome3 display-none">
		   ...
		   <div class="checkbox">
            ...
            <div class="row">
				<div class="col-xs-6 col-md-5 col-lg-3">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInputHome2back()">ก่อนหน้า</button>
				</div> 
				<div class="col-xs-6 col-md-5 col-md-push-2 col-lg-3 col-lg-push-6">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInputHome4()">ถัดไป</button>
				</div>
			</div>
			<br>
		</div>
		...
		<div class="inputhome4 display-none">
            ...
            <div class="row">
				<div class="col-xs-6 col-md-5 col-lg-3">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInputHome3back()">ก่อนหน้า</button>
				</div> 
				<div class="col-xs-6 col-md-5 col-md-push-2 col-lg-3 col-lg-push-6">
					<button type="button" class="btn btn-warning col-xs-12 text-white" onclick="submitInputHome4()">ถัดไป</button>
				</div>
