...
<div class="n-container padding-none">
	<div id="mapmenu-mb" class="container-fluid padding-none hidebar2">  
		<!--menu mobile Add Nov12-->
		<div class="container-fluid visible-xs visible-sm padding-none padding-clear-bottom">
			<div class="hidebar">
				<div id="col_showprice" class="pull-left col-xs-6 text-center display-none text-center ">
					<select id="showprice" class="form-control input-sm font16 w100p bg-white" title="ราคา">
						<option value="0">ไม่ระบุงบ</option>
						<option value="1">< 1ล้าน</option>
						<option value="2">1-2ล้าน</option>
						<option value="3">2-3ล้าน</option>
						<option value="4">3-5ล้าน</option>
						<option value="5">5-10ล้าน</option>
						<option value="6">> 10ล้าน</option>
					</select>
				</div>		


				<div id="col_show_filter" class="col-xs-3 text-center padding-left-clear">
					<button id="showfilter" type="button" class="btn btn-white-s col-xs-12"> <a id="showfilter" href="#" class="text-orange2 font16">ตัวกรอง</a></button>
				</div>
				<div id="col_sort_filter" class="col-xs-6 padding-none text-center" style=" padding-bottom: 0; padding-top: 0;">
					<select id="sOrder_mb2" class="form-control border-none input-sm font16 bg-white" style="height: 29px">
						<option class="pull-left font16" value="" disabled="disabled" value="" selected>เรียงตาม..</option>
						<option class="pull-left font16" value="0">ชื่อโครงการ</option>
						<option class="pull-left font16" value="1">ราคา ต่ำ-สูง</option>
						<option class="pull-left font16" value="8">ราคา สูง-ต่ำ</option>
						<option class="pull-left font16" value="2">ราคา/ตร.ม. ต่ำ-สูง</option>
						<option class="pull-left font16" value="3">ราคา/ตร.ม. สูง-ต่ำ</option>
						<option class="pull-left font16" value="4">ปีสร้างเสร็จ ใหม่-เก่า</option>
						<option class="pull-left font16" value="5">ระยะจากจุดที่ค้นหา</option>
						<option class="pull-left font16" value="6">ระยะจากรถไฟฟ้า</option>
						<option class="pull-left font16" value="7">จำนวนห้องนอน</option>
					</select>
				</div>
				<!--<div id="mk_unit_mb" class="col-xs-2 padding-none padding-l5i text-orange2"></div>-->
				<div id="col_list-photo" class="col-xs-3 padding-none padding-top-clear text-center">
					<button type="button" id="picture_listing_mb" class="btn btn-list2  padding-none padding-top-clear" aria-label="Right Align">
						<a href="#" class="btn-md padding-none"><span class="glyphicon glyphicon-picture text-grey2 " aria-hidden="true" disabled="disabled" style="font-size: 23px; opacity:0.6"></span></a>
					</button>
					<button type="button" id="data_listing_mb" class="btn btn-list  padding-none padding-top-clear padding-l3" aria-label="Right Align">
						<a href="#" class="btn-md padding-none"><span class="glyphicon glyphicon-th-list text-grey2  " aria-hidden="true" height="15" style="font-size: 23px;"></span></a>
					</button>
				</div>
				<div id="col_show_idetail" class="col-xs-3 text-center visible-xs display-none2 padding-left-clear padding-right-clear" >
					<button id="show_idetail" type="button" class="btn  btn-white-s col-xs-12 w100p" style="border-left:1px solid #cccccc"> <a href="#" class="text-orange2 font16">ข้อมูลหมุด</a></button>
				</div>
			</div>
		...
		<div id="mapmenu" class="container-fluid hidden-xs hidden-sm bg-white fixed margin-t50" style="z-index:100000;">
			<div class="w21 pull-left">
				<div class="pull-left w20 padding-t4 margin-t4 text-left padding-l10-clear">
					<div class="btn-group pos-rlt">
						<button type="button" id="button-distance" class="btn dropdown-toggle padding-none padding-t2" style="background-color:#FFFFFF;border:0;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div class="pull-left w20 padding-t6 text-center font14 padding-l12">จาก</div>
				<div class="pull-left w60 padding-t3 text-center padding-r5">
			...
			<div class="w33 nopadding pull-left">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li>
								&nbsp;&nbsp;
								<label class="filter-legend">
									<input type="checkbox" class="sTypeSale" name="sTypeSale" value="8" <?=$Advertising_check6;?> data-checkbox-text="ขายห้องโครงการ"> 
									ขายห้องโครงการ
			...
			<!--End Add Nov19-->  
			<div class="w23 nopadding pull-left">
			...
			<hr class="visible-xs blank">
			<div class="w20 pull-left hidden-xs padding-t-ipad">
				<div class="pull-left w45 padding-t3 text-center padding-l5-clear">
					<input type="text" value="" id="minPrice" name="minPrice" placeholder=" ราคาต่ำสุด" class="form-control">  
				</div>
				<div class="pull-left w5 padding-t6 text-right padding-t3 text-center padding-none">
					-
				</div>
				<div class="pull-left w45 padding-t3 text-center border-right padding-r5-clear">
				...
				<div id="wrapper_map">
					...
					<div class="map-float-menu hidden-xs">
						<div class="unitcounter">
							<span id="unitcounter"></span> ยูนิต
						</div>
...
<!-- 					<div id="float_menu5" class="text-center hidden-xs hidden-sm">
				...
				<div id="market_div" style="height:110px;" class="hidden-xs">
					<button type="button" class="btn-close market-close text-grey2" onclick="showMarket();">
			...
			<div class="clearfix"></div>
			<div id="showWarning" class="col-md-12 text-center display-none"><b>* หน้านี้จะแสดงผลได้ดี ก็ต่อเมื่อแสดงผลในแนวนอน</b></div>

			<div class="w30x col-md-4-result padding-none clear-padding-lr padding-t10x" id="searchmapsidebar">

				<!--filter box for mobile-->
				<div class="text-left visible-sm" style="width:100%;background-color:orange; padding-left:8px; padding: 5px 0px;height:40px;">
				...
				<!--wrapper-->
				<div class="hidden-sm hidden-xs" id="searchmapshowcase" style="position: fixed; left: 70%;z-index: 100;width: 30%;">
					<!--banner-->
					...
					<div class="text-left padding-none filter-hide-mobile visible-lg visible-md hidden-sm" style="width:100%;background-color:orange; padding-left:8px; padding: 5px 0px;height:40px;">
						...
						<div class="col-xs-12 nopadding">
							...
							<div class="col-xs-5 col-lg-7 nopadding" style="line-height:30px;">
								<select id="sOrder" class="col-xs-12 input-sm no-border padding-none small2 pointer" data-style="btn-noborder" data-width="auto">									
									<option class="small2" disabled="disabled" value="">เรียงตาม..</option>
									<option class="small2" value="0">ชื่อโครงการ</option>
									<option class="small2" value="1">ราคา ต่ำ-สูง</option>
									<option class="small2" value="8">ราคา สูง-ต่ำ</option>
		...
		<div id="cImgUnitsMobile2" class="col-md-12 col-xs-12 padding-none q-sooth" style="background-color:#FFFFFF;padding:0;margin-top:94px;position: fixed;top:0px;left:0px;"></div>
	</div>
</div>
...
function updateSearch(){
	...
	var txt_link="/Zhome/searchResult2/0/"+refPl2+"/"+minP2+"/"+maxP2+"/"+dist+"/"+tSale2+"/"+propType2+"/"+nBed2+"/"+nBath2+"/"+nTransDist2+"/"+nTransType2+"/"+nYear2;
	var new_url_link=url_link+txt_link;
	
	$.when($.getJSON("/zhome/getUpdateMarker",{ viewmode:1,distance:dist,namePoint:refPl,TOProperty:propType,Bedroom:nBed,Bathroom:nBath,TransDist:nTransDist,TransType:nTransType,Year:nYear,TOAdvertising:tSale,minPrice:minP,maxPrice:maxP,Order:Order }),
	$.getJSON("/zhome/getUpdateMarker",{ viewmode:2,distance:dist,namePoint:refPl,TOProperty:propType,Bedroom:nBed,Bathroom:nBath,TransDist:nTransDist,TransType:nTransType,Year:nYear,TOAdvertising:tSale,minPrice:minP,maxPrice:maxP,Order:Order }),
	...
	$.getJSON("/zhome/getMarketCont",{ namepoint:refPl,distance:dist,advertising:tSale,nowyear:nowyear,proptype:propType,bedroom:nBed,bathroom:nBath,transdist:nTransDist,TransType:nTransType,age:nYear,minPrice:minP,maxPrice:maxP })
...
function displayImgUnitsMobile(type,n,mode,showbanner){
	...
	if($('#mobile_detect').val()==0 || ($('#mobile_detect').val()==1 && type!='map')){
		...
		if($('#mobile_detect').val()==1 && i==-1 && showbanner==1){
			if(imgBannerUnit.length>0){
				for(b=0;b<m;b++){
					...
					imgNode += '<div class="item active '+list_class+' thumbnail-banner" style="overflow:hidden;margin: 0px 0px;background-color:#ffffff; background-image:url('+imgBannerUnit[b].Picture+') ; background-repeat: no-repeat;background-position: center center;background-size:100%; padding-left: 0; padding-right: 0; '+list_style+'">';
		...
		for(i=x;i<imgUnits.length;i++){
			if((type=='list_data' && i==x) || (type=='list_pic' && i==count)){
				...
				if(mobile_banner==0 || (mobile_banner==1 && (type=='list_data' && i!=0)) || type=='list_pic'){
					imgNode += '<div class="item '+active+' '+list_class+'" data-project="'+imgUnits[i].ProjectName+'" data-project-id="'+imgUnits[i].PID+'" style="overflow:hidden;margin: 0px 0px;background-color:#ffffff; background-image:url('+imgUnits[i].Picture[0]+') ; background-repeat: no-repeat;background-position: center center;background-size:100%; padding-left: 0; padding-right: 0; '+list_style+'" onmouseover=focusMapIcon(this,'+i+','+imgUnits[i].PID+',1); onmouseout=focusMapIcon(this,'+i+','+imgUnits[i].PID+',0);>';
					imgNode += '<div class="carousel-caption-rt">';
					imgNode += '<div class="infogp-box">';
				...
				if(type=='list_data'){
					if($('#mobile_detect').val()==1){
						/* for mobile*/
						imgNode += '<table class="col-md-12 table borderless2 unit-table visible-sm visible-xs nomargin">';
						imgNode += '<tr style="padding:0;margin:0;" class="bg-grey-header">';
						imgNode += '<td class="w39 s-padding-left text-primary text-blue text-left">โครงการ</td>';
						imgNode += '<td class="w12 text-primary text-blue text-center">รถไฟฟ้า</td>';
						imgNode += '<td class="w10 text-primary text-blue text-center">นอน</td>';
						imgNode += '<td class="w11 text-primary text-blue text-left">ตร.ม.</td>';
						imgNode += '<td class="w10 text-primary text-blue text-left">ชั้น</td>';
						imgNode += '<td class="w19 text-primary text-blue text-right dprice '+display_price+'">บาท</td>';
						imgNode += '<td class="w19 text-primary text-blue text-right dpricesq '+display_pricesq+'">บาท/ม&sup2</td>';
						imgNode += '</tr>';
						imgNode += '</table>';
						/* end mobile*/
					}
		...
		for(var i=0;i<imgUnits.length;i++){
			if(type=='map' && imgUnits[i].PID==returnSearch[n].PID){
				...
				imgNode += '<div class="panel item q-mbmap-item heightratio2" data-project="'+imgUnits[i].ProjectName+'" data-project-id="'+imgUnits[i].PID+'" style="background-image:url('+imgUnits[i].Picture[0]+');background-repeat: no-repeat;background-position: center center;background-size:100%; padding-left: 0; padding-right: 0;">';
...
function displayImgUnitsMobile2(type,n){
	...
	listNode_2 +=	'<table class="col-md-12 table borderless2 unit-table hidden-sm hidden-xs " style="padding:0px 0px 0px 0px;margin:0px;font-size:16px;">';
	listNode_2 +=	'<tr style="padding:0;margin:0;" class="bg-grey-header">';
	listNode_2 +=	'<td class="w39 s-padding-left text-primary text-blue text-left">โครงการ</td>';
	listNode_2 +=	'<td class="w12 text-primary text-blue text-right">รถไฟฟ้า</td>';
	listNode_2 +=	'<td class="w10 text-primary text-blue text-right">นอน</td>';
	listNode_2 +=	'<td class="w13 text-primary text-blue text-right">ตร.ม.</td>';
	listNode_2 +=	'<td class="w10 text-primary text-blue text-right">ชั้น</td>';
	listNode_2 +=	'<td class="w17 text-primary text-blue text-right dprice '+display_price+'">บาท</td>';
	listNode_2 +=	'<td class="w17 text-primary text-blue text-right dpricesq '+display_pricesq+'">บาท/ม&sup2</td>';
	listNode_2 +=	'</tr>';
	listNode_2 +=	'</table>';
	listNode_2 += '</div>';
	if ($('#mobile_detect').val()!=1) {
		listNode += '<div id="showTb2">';
		listNode +=	'<table class="col-md-12 table borderless2 unit-table hidden-md hidden-lg" style="padding:0px 0px 0px 0px;margin:0px;font-size:16px;">';
		listNode +=	'<tr style="padding:0;margin:0;" class="bg-grey-header">';
		listNode +=	'<td class="w39 s-padding-left text-primary text-blue text-left">โครงการ</td>';
		listNode +=	'<td class="w12 text-primary text-blue text-right">รถไฟฟ้า</td>';
		listNode +=	'<td class="w10 text-primary text-blue text-right">นอน</td>';
		listNode +=	'<td class="w13 text-primary text-blue text-right">ตร.ม.</td>';
		listNode +=	'<td class="w10 text-primary text-blue text-right">ชั้น</td>';
		listNode +=	'<td class="w17 text-primary text-blue text-right dprice '+display_price+'">บาท</td>';
		listNode +=	'<td class="w17 text-primary text-blue text-right dpricesq '+display_pricesq+'">บาท/ม&sup2</td>';
		listNode +=	'</tr>';
		listNode +=	'</table>';
		listNode += '</div>';
	}
	...
	for(var i=0;i<imgUnits.length;i++){
		...
		listNode += '<div id="'+imgUnits[i].POID+'" data-project="'+imgUnits[i].ProjectName+'" data-project-id="'+imgUnits[i].PID+'" class="unit-show hilight_project padding-none;">';
		...
		listNode += '<table class="table borderless2 unit-table col-md-12 padding-none" style="padding:0;margin:0;font-size:16px; width:100%;height:30px;" onclick=displayImgUnitsMobile("list_data",'+i+',0,0); onmouseover=focusMapIcon(this,'+i+','+imgUnits[i].PID+',1); onmouseout=focusMapIcon(this,'+i+','+imgUnits[i].PID+',0); ondblclick=window.open("/'+imgUnits[i].NamePath+'/condo/'+imgUnits[i].PName_en+'/'+imgUnits[i].POID+'"); onmousedown=ListPanMap('+i+');>';
		listNode += '<tr style="border-bottom: 1px solid #dbdbdb; padding:0;margin:0;cursor:pointer;">';
		listNode += '<td class="w39 s-padding-left text-primary text-grey text-left">'+imgUnits[i].ProjectNameCenter+'</td>';
		listNode += '<td class="w12 text-primary text-grey text-right">'+imgUnits[i].DistNameList+'</td>';
		listNode += '<td class="w10 text-primary text-grey text-right">'+imgUnits[i].BedroomList+'</td>';
		listNode += '<td class="w13 text-primary text-grey text-right">'+useArea+'</td>';
		listNode += '<td class="w10 text-primary text-grey text-right">'+imgUnits[i].Floor+'</td>';
		listNode += '<td class="w17 text-primary text-grey text-right dprice '+display_price+'">'+imgUnits[i].PriceShow+'</td>';
		listNode += '<td class="w17 text-primary text-grey text-right dpricesq '+display_pricesq+'">'+imgUnits[i].PricePerSqShow+'</td>';
		listNode += '</tr>';
		listNode += '</table>';
	...
	if(imgBanner.length>0){
		...
		for(var i=0;i<imgBanner.length;i++){
			...
			if(imgBanner[i].POID!='0'){
				...
				listBanner += '<div class="item '+active+' heightratio thumbnail-banner" style="overflow:hidden;margin: 0px 0px;background-color:#ffffff; background-image:url('+imgBanner[i].Picture+') ; background-repeat: no-repeat;background-position: center center;background-size:100%; padding-left: 0; padding-right: 0;">';
	...
	<div class="col-xs-12 filter filter-fold">
		...
		<div class="row ">
			<div class="col-md-12 ">
				...
				<div class="col-xs-4">
					<label class="checkbox">
						<input type="checkbox" class="sTypeSale_mb" name="sTypeSale_mb[6]" value="8" <?=$Advertising_check6;?> onclick="check_typesale(this.value);"><div class="padding-t2">ขายห้องโครงการ</div>
					</label>
				</div>
				<div class="col-xs-4">
					<label class="checkbox">
...
$('#showprice').change(function(){
	nPriceList = $('#showprice option:selected').val();
