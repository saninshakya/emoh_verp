		...
		if(returnPromotion[0].checkCode==1){
			...
			if(returnPromotion[0].promotion_type==1 || returnPromotion[0].promotion_type==3){//1:Discount Payment , 3:Add on (Extra Credit)
				...
				?>
					...
					listPromotion +='<div class="col-lg-4 col-md-4 radio <?=$radioClass;?>">';
					listPromotion +='<div class="col-lg-12 col-md-12 border-boost2">';
					if(returnPromotion[0].promotion_type==1){
						listPromotion +='<div class="col-lg-7 col-md-5 col-sm-6 col-xs-6 padding-none">';
					}else if(returnPromotion[0].promotion_type==3){
						listPromotion +='<div class="col-lg-8 col-md-5 col-sm-6 col-xs-6 padding-none">';
					}
					...
					if(returnPromotion[0].promotion_type==1){
						...
						listPromotion +='<span class="text-black"><?=number_format($row->Credit);?>+'+value_new+' <img src="/img/zcoin01.png" class="coin-logo" width="12px" height="12px"></img></span>';
					}
					listPromotion +='</label>';
					listPromotion +='</div>';
					if(returnPromotion[0].promotion_type==1){
						listPromotion +='<div class="col-lg-5 col-md-7 col-sm-6 col-xs-6 text-right padding-t4 padding-none"><span class="text-payment2">'+price_new+' บาท </span><span class="text-payment2 text-red"> - '+value+'%</span></div>';
					}else if(returnPromotion[0].promotion_type==3){
						listPromotion +='<div class="col-lg-4 col-md-7 col-sm-6 col-xs-6 text-right padding-t4 padding-none"><span class="text-payment2">'+price_new+' บาท </span><span class="text-payment2 text-red"> + '+value_show+'%</span></div>';
					}
					listPromotion +='</div>';
					listPromotion +='</div>';
