...
<div class="container">
        ...
        <div class="row">
                	...
                	<div class="col-md-8">
    					         - มูลค่าขายดาวน์ (รวมค่าเปลี่ยนสัญญา่ ถ้ามี)
    				      </div>
				          <div class="col-md-4">
       ...
       <div class="row">
			...
			<div class="row">
               ...
               <div class="col-md-4">
                ...
                <select class="form-control input-md" name="AgreePostDay" id="AgreePostDay" onchange="updatePost('AgreePostDay')" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['agreepostday_title'][0];?>" onmouseover="show_title('<?=$qLabel['agreepostday_title'][0];?>');" onmouseout="hide_title();">
              ...
              <div class="col-md-12">
                   <h5>ต้องการใช้บริการนายหน้า</h5>
                    <ul class="list-inline">
                      ...
                      <li><div style="margin-left:16px;"><span class="text-danger">ค่าบริการ 2.0%</span><span class="text-danger" id="showDBrokerPrice">฿<?php echo number_format($this->post->checkPost('DBrokerPrice'),0,'.',',');?></span></div></li>
                    </ul>
                   ...
                   <input class="form-control input-md" type="text" name="showDReadyPayment" id="showDReadyPayment" value="฿<?php echo number_format($this->post->checkPost('DReadyPayment'),0,'.',',');?>" onclick="this.value=document.getElementById('DReadyPayment').value" onchange="changeFormat('showDReadyPayment','DReadyPayment');setTimeout(function(){calDDownTotalPrice()}, 100);" OnKeyPress="return chkNumber(this)" data-toggle="tooltip" data-placement="bottom" title="<?=$qLabel['dreadypayment_title'][0];?>" onmouseover="show_title('<?=$qLabel['dreadypayment_title'][0];?>');" onmouseout="hide_title();">
                      ...
                      <div id="showDStalePayment" class="padding-top38">
                       <?php
            					...
            					?>
            						เหลือผ่อนดาวน์ ฿<?=number_format($this->post->checkPost('DStalePayment'),0,'.',',');?>
            					<?};?>
                      </div>   
                  </div>
                  <div class="col-md-4">
      ...
      <br>
			<div class="row">
                   ...
                   <input class="form-control input-md" type="text" name="DStalePaymentMonth" id="DStalePaymentMonth" value="<?php echo $this->post->checkPost('DStalePaymentMonth');?>" onchange="updatePost('DStalePaymentMonth');showDStalePaymentMonth();"  OnKeyPress="return chkNumber(this)" >
                  </div>
			</div>
			<div class="row">
                  <div class="col-md-4">
            ...
            <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="checkbox table-bordered padding-pro6">
                          <label>
                           <input type="checkbox" name="DFreeMember" id="DFreeMember" <?php if ($this->post->checkPost('DFreeMember')=='1'){echo "Checked";};?> value="<?php echo $this->post->checkPost('DFreeMember');?>" onclick="changeValue2('DFreeMember');"><div class="text-grey">ฟรีเงินกองทุนนิติบุคคลฯ</div>
                          </label>
                    </div>
