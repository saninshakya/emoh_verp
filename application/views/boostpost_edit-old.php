			...
			<div class="row padding-none">
				    <div class="col-md-12 padding-l20">
			              <div class="col-xs-12 padding-l15">     
			                    <p class="text-black padding-none "> <b>สรุปยอด</b></p>
			              </div>
			              <div class="clearfix"></div>
			              <div class="height15"></div>
			              <div class="col-xs-12 padding-none">
			                    <div class="col-xs-8 text-left">
			                     ...
			                     <div class="col-xs-4 text-right">
			                         <p class="text-grey padding-none ">100 ครั้ง</p>
			                    </div>
			                    <div class="clearfix"></div>
				                <div class="height15"></div>
				                <div class="col-xs-6 text-left">
			                     ...
			                     <div class="col-xs-6 text-right">
			                         <p class="text-grey padding-none ">134 ครั้ง</p>
			                    </div>
			                    <div class="clearfix"></div>
			                     <div class="height15"></div>
				                <div class="col-xs-6 text-left">
			                         <p class="text-black padding-none ">โปรโมตต่อวัน</p>
			                    </div>
			                     <div class="col-xs-6 text-right">
			                         <p class="text-grey padding-none ">80 ครั้ง/วัน</p>
			                    </div>
			                    <div class="clearfix"></div>
			                     <div class="height15"></div>
				                <div class="col-xs-6 text-left">
			                     ...
			                     <div class="col-xs-6 text-right">
			                         <p class="text-grey padding-none ">__/__/__</p>
			                    </div>

			              </div>
			              <div class="clearfix"></div>
			              <div class="height15"></div>
			              <div class="margin-l15 margin-r15  border-grey text-center">
			                <div class="clearfix"></div>
			                <div class="height5"></div>
			            
			                <div class="col-md-12 col-xs-12 ">
			                   <div id="pauseads" class="text-black "><a href="#" class="text-black" data-toggle="modal" data-target="#modalPause">หยุดโฆษณาชั่วคราว</a></div>
			                   <div id="showads" class="display-none">  <a href="#" class="text-red">แสดงประกาศ</a></div>
			                </div>
		      ...
		      <div class="col-md-12">
		               <div class="col-md-12 text-black text-left"><span class="text-green2">แก้ไข</span>จุดเด่นประกาศ<span class="text-blue">(45)</span> <a href="#" class="text-red">เงือนไขการเขียน</a></div>
		               <div class="clearfix"></div>
				       <div class="height10"></div>
		               <div class="col-md-12 text-left"><input type="text" class="form-control input-sm"></div>
              ...
              <hr class="bg-grey7 padding-none height10">
		          ...
		          <div class="col-md-12">
		               ...
		               <div class="clearfix"></div>
				       <div class="height10"></div>
		               <div class="text-center"><h3 class="text-green2 padding-none">150 ครั้ง/วัน</h3></div>
		               <div class="clearfix"></div>
				       <div class="height20"></div>
		               <div class="text-center text-black">จำนวนโฆษณาคงเหลือ </div>
		               <div class="clearfix"></div>
				       <div class="height10"></div>
		               <div class="text-center"><h3 class="text-warning padding-none">0 ครั้ง</h3></div>
				  ...
				  <div class="row padding-none">
				    <div class="col-md-12 padding-l20">
			              <div class="col-xs-12 padding-l15">
			                    <div class="pull-left">
			                            <p class="text-black padding-none "> <span class="text-green2">แก้ไข</span>จำนวนการโปรโมทสูงสุดต่อวัน</p>
			                            <p class="text-black padding-none "> ใช้ 1เหรียญ/การโปรโมท 1 ครั้ง</p>
			              ...
			              <div class="col-xs-12 radio padding-none">
							    <div class="col-xs-12"> 
							       <label onclick="clear_custom_ads();checkpayment1()">
						  ...
						  <div class="col-xs-12 radio padding-none">
							    <div class="col-xs-12"> 
							      <label onclick="clear_custom_ads();checkpayment2()">
						  ...
						  <div class="col-xs-12 radio padding-none">
							    <div class="col-xs-12"> 
							      <label onclick="clear_custom_ads();checkpayment3()">
							        <div class="pull-left"><input type="radio" name="optionsRadios2" id="optionsRadios3" value="option3"></div>
							        <div class="text-black pull-left margin-t21m">500 ครั้ง</div>
							      </label>
							     </div>
						  </div>
						  <div class="clearfix"></div>
						  ...
						  <div class="col-xs-12 radio padding-none">
							    <div class="col-xs-12"> 
							     <label onclick="custom_ads();">
							        ...
							        <div class="pull-left"><input id="option_custom2"  type="text" class="form-control input-sm display-none" onchange="checkpayment4()" value=""> </div>
				  ...
				  <div class="row padding-none">
				    <div class="col-md-12 padding-l20">
						  <div class="col-md-12 col-xs-12 padding-l15">
			                    <div class="pull-left">
			                            <p class="text-black padding-none "> แก้ไขจำนวนวันที่ต้องการแสดงโฆษณา</p>
			              ...
			              <div class="col-xs-12 radio padding-none">
							      ...
							      <label class="col-xs-12">
							       <div class="col-xs-8">
								       <div class="pull-left"><input type="radio" name="optionsRadios3" id="optionsRadios1" value="option1" selected></div>
								       <div class="text-black pull-left margin-t21m">1 วัน</div>
								   </div>
							       <div class="col-xs-4 text-right text-grey margin-t21m">__/__/__</div>
							      </label>
						  ...
						  <div class="col-xs-12 radio padding-none">
							      ...
							      <label class="col-xs-12">
								       <div class="col-xs-8">
									       <div class="pull-left"><input type="radio" name="optionsRadios3" id="optionsRadios2" value="option2"></div>
						  ...
						  <div class="col-xs-12 radio padding-none">
							      <label class="col-xs-12">
								       <div class="col-xs-8">
									       <div class="pull-left"><input type="radio" name="optionsRadios3" id="optionsRadios3" value="option3" ></div>
						  ...
						  <div class="col-xs-12 radio padding-none">
							       ...
							       <label  class="col-xs-12" onclick="custom_ads2();">
							        <div class="col-xs-8">
							          <div class="pull-left">
							             <input type="radio" name="optionsRadios3" id="optionsRadios4" value="option4">
							          </div>
							          ...
							          <div id="date_custom2" class="form-group col-xs-12 display-none padding-none">
						                 <div class='input-group date' id='boostpost-date'>
						                    <input type="text" id="datepicker" class="padding-none">
						                 </div>
						              </div>
		                            </div>
						    ...
						    <div class="col-md-12 padding-l20">
								  <div class="col-md-12 col-xs-12 padding-l15">
					                    ...
					                    <div class="text-center text-red">
					                            เหลือ__เหรียญ จากแผน__เหรียญ

					                    </div>
					                    <div class="clearfix"></div>
						                <div class="height10"></div>
					                    <button class="btn btn-green2 cursor input-z col-xs-12 text-white" onclick="window.open('/zhome/payment','_self'),parent">ซื้อเหรียญเพิ่ม</button>
					              </div>
					        </div>
					      </div>
						    ...
						    <div class="col-md-12 padding-l20">
								  <div class="col-md-12 col-xs-12 padding-l15">
						               ...
						               <div class="height15"></div>
                                        ...
                                        <div class="clearfix"></div>
										 <div class="height10"></div>
					                    <div class="col-md-12"><a class="text-black" href="#"><b>เงื่อนไขการโฆษณา</b></a><span class="text-red"> (อ่านก่อนกดลงโฆษณา)*</div>
						                  <div class="clearfix"></div>
						                  <div class="height15"></div>
						                  <div class="col-xs-12 checkbox padding-none">
											    <div class="col-xs-12"> <label><input type="checkbox" name="optionsCondition" id="optionsCondition" value="" onchange="checkCondition();" ><span class="text-blue">ข้าพเจ้าจะไม่ใช้คำไม่สุภาพ ส่อเสียด เกินจริง สื่อความหมายทางเพศในการโปรโมทประกาศ</span></label>
											    </div> 
										  </div>
										  <div class="clearfix"></div>
										  <div class="height15"></div>
										  <div class="col-xs-12 checkbox padding-none">
											    <div class="col-xs-12"> <label><input type="checkbox" name="optionsCondition" id="optionsCondition2" value="" onchange="checkCondition();" ><span class="text-blue">ข้าพเจ้าจะใช้ภาพถ่ายแนวนอนและเก็บห้องให้เรียบร้อย โดยเว็บไซต์มีสิทธิไม่อนุมัติหากภาพถ่ายไม่ได้คุณภาพ</span></label>
											    </div> 
										  </div>
										  <div class="clearfix"></div>
										  <div class="height15"></div>
              ...
              <div class="col-md-12 bg-grey7 boost-map-height bg-grey" style="position:fixed; bottom:0; left:0; width:100%;">
              	 <div class="clearfix"></div>
                 <div class="height15"></div>
                 <button type="submit" id="payment-bt" class="btn btn-green2 cursor input-z col-xs-12 text-white" onclick="checkCondition2();"> <h5 class="text-white padding-none padding-t2"><p id="text-payment-bt">โปรโมท___ครั้ง/วัน  ถึง__/__/__</p></h5>
                 </button>
                 <div class="clearfix"></div>
                 <div class="height5"></div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content text-center">
			...
			<div class="modal-body" style="height:200px">
			    <br><br>
				<h4>กรุณาคลิกยอมรับเงื่อนไขการโฆษณา</h4>
				<br>
			</div>
		</div>
	</div>
...
<div class="modal modal-sm fade display-none" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="margin-right: auto;margin-left: auto;">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header bg-blue" style="padding:10px 15px 5px;">
				<div class="pull-right"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><big>&times;</big></span></button></div>
				<h4 class="text-white text-center padding-none padding-t3"> สรุป</h4>
			</div>
			<div class="modal-body padding-none" style="height:295px">
				<div class="clearfix"></div>
                <div class="height20"></div>
				 <div class="col-xs-8 text-black">
				    <p class="text-black">ประกาศสูงสุด/วัน : </p>
				 </div>
				 <div class="col-xs-4 text-right text-black">
				    <p class="text-black"> 500 ครั้ง</p>
				 </div>
				 <div class="col-xs-6 text-black">
				   <p class="text-black">แสดงผลระหว่าง : </p>
				 </div>
				 <div class="col-xs-6 text-right text-black">
				   <p class="text-black"> __/__/__ - __/__/__</p>
				 </div>
				 <div class="clearfix"></div>
                <div class="height20"></div>
				 <div class="col-xs-12 text-orange">โฆษณาจะหยุดแสดงเมื่อเลยวันที่คุณกำหนดหรือเหรียญของคุณหมด</div>
				 <div class="clearfix"></div>
                 <div class="height20"></div>
                 <div class="height10"></div>
                 <div class="col-xs-12">
				   <button class="btn bg-orange cursor input-z col-xs-12 text-white" onclick="window.open('','_self'),parent">ยืนยัน</button>
				 </div>
				<div class="clearfix"></div>
                <div class="height10"></div>
				 <div class="col-xs-12">
 ...
 <!-- End Modal Confirm -->
 <!-- Modal Pause -->
<div class="modal modal-sm fade display-none" id="modalPause" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="margin-right: auto;margin-left: auto;">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header bg-blue" style="padding:10px 15px 5px;">
				<div class="pull-right"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><big>&times;</big></span></button></div>
				<h4 class="text-white text-center padding-none padding-t3"> หยุดโฆษณาชั่วคราว</h4>
			</div>
			<div class="modal-body padding-none" style="height:295px">
				<div class="clearfix"></div>
                <div class="height20"></div>
                ...
                <div class="height10"></div>
                <br> <br> 
				 <div class="col-xs-12 text-green text-center"><h4 class="text-green">คุณแน่ใจว่าต้องการหยุดโฆษณา?</h4></div>
				 <div class="clearfix"></div>
                 <br> <br><br> 
                  <div class="clearfix"></div>
                 <div class="col-xs-12">
				   <button class="btn bg-grey4 cursor input-z col-xs-12 text-white"  data-dismiss="modal" aria-label="Close" onclick="pauseads();">ตกลง</button>
				 </div>
				<div class="clearfix"></div>
                <div class="height10"></div>
				 <div class="col-xs-12">
				    <button class="btn bg-orange cursor input-z col-xs-12 text-white" data-dismiss="modal" aria-label="Close">ยกเลิก</button>
				 </div>
			</div>
		</div>
	</div>
