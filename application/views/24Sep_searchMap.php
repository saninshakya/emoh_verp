        ...
        <div class="row">  
          <div class="col-md-12">
              <ul class="list-inline">
                      <li>
                         <input type="text" value="" size="3" id="iDistance" name="iDistance" placeholder="0">
                      </li>
                      <li>ม.จาก</li>
                      <li class="border-right"> 
                          <input type="text" size="20" value="" id="iRefPlace" name="iRefPlace" placeholder=" เขต,รถไฟฟ้า,โครงการ" autocomplete="off">
                      </li>
                      ...
                      <li>
                              <input type="text" size="10" value="" id="minPrice" name="minPrice" placeholder=" ราคาต่ำสุด">  
                          </li>
                      <li>-</li>
                      <li>
                              <input type="text" size="10" value="" id="maxPrice" name="maxPrice" placeholder=" ราคาสูงสุด">
                      </li>
...
for(var i=0;i<returnSearch.length;i++){
	...
	var lcontent = "<div class='line-map'>"+lunit+"</div>"+lprice;
