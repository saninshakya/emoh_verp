          ...
          <div class="row border-grey2">
            ...
            <div class="col-md-12 bg-box-grey">
               <div class="col-md-12"">
                <ul class="list-inline padding-top3 padding-lr2">
                      ...
                      <li class="text-white pull-right padding-top6">
					  <h8>
            ...
            <div>
                      ...
                      <div class="pull-left w34">
                         ...
                         <div class="pull-right padding-r5">
                             <div class="pull-right text-white"><h6><?=$Direction;?></h6></div>
                             <div class="h7 text-white">SE</div>
                         </div>
                      </div>
            ...
            <div class="col-md-10 bg-blue text-white text-center padding-top2"><input type="hidden" id="otel" value="">
              ...
              <!--End 9oct58-->
             <div class="col-md-1"></div> 
             <div class="col-md-12 text-center padding-top1"><div class="text-primary">แจ้ง! : <a class="text-primary" href="#" data-toggle="modal" data-target="#myModal"> ไม่ใช่เจ้าของ</a> <a class="text-primary" data-toggle="modal" data-target="#myModal" style="padding-left:7px;" href="#">  ขายแล้ว</a> <a class="text-primary" data-toggle="modal" data-target="#myModal" href="#" style="padding-left:7px;">  ขึ้นราคา</a> <a class="text-primary" data-toggle="modal" data-target="#myModal" href="#" style="padding-left:7px;">  ข้อมูลผิด</a> </div></div>
             <div class="clearfix"></div><br>
          </div>
         <div class="clearfix"></div> 
          <!--Alert-->
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body text-grey row">
                      ...
                      <div class="clearfix"></div>
                      <br>
                      <div class="col-md-12"><input class="btn-md" placeholder="ชื่อ-สกุล" style="width:250px;"></div>
                      <div class="clearfix"></div>
                  
                      <div class="col-md-12 padding-top10"><input class="btn-md" placeholder="อีเมล" style="width:250px;"></div>
                      <div class="clearfix"></div>
                       <div class="col-md-12 padding-top10"><input class="btn-md" placeholder="เบอร์ติดต่อ" style="width:250px;"></div>

                      <div class="clearfix"></div>
                  
                      <div class="col-md-12 padding-top10">
                       
                        <select class="selectpicker input-md form-control text-grey">
                          <option value="1" class="text-grey">ไม่ใช่เจ้าของ</option>
                          <option value="2" class="text-grey">ขายแล้ว</option>
                          <option value="3" class="text-grey">ขึ้นราคา</option>
                          <option value="4" class="text-grey">ข้อมูลผิด</option>
                        </select>
                       
                      </div>
                      <div class="clearfix"></div>
                      <div class="col-md-12 padding-top10"><textarea class="form-control" placeholder="คุณทราบได้อย่างไร" rows="3" style="width:250px;"></textarea></div>

                      <div class="clearfix"></div>
                   
                      <div class="col-md-12 padding-top10"><button type="button" class="btn btn-orange" data-dismiss="modal" style="width:250px;">แจ้งประกาศ</button></div>
