...
$start_date2=$this->credit->selectDateBoostPost($POID,1);
$sdate_array2=explode("-",$start_date2);
$start_date_show2=$sdate_array2[2].'/'.$sdate_array2[1].'/'.$sdate_array2[0];
	...
	<div class="padding-none">
		...
		<div id="summaryBoost" class="col-lg-4 col-md-4 col-sm-12 col-xs-12 padding-none-pc">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-none">
				...
				<div class="height15"></div>
				<div class="col-lg-8 col-md-8 col-xs-6 text-left padding-none-pc">
					 <p class="text-black padding-none ">โปรโมทแล้วเฉลี่ย</p>
				</div>
				 <div class="col-lg-4 col-md-4 col-xs-6 text-right padding-none-pc">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 padding-none-pc">
            ...
            <div class="col-lg-12 col-md-12 padding-none-pc">
				...
				<div class="pull-right padding-none col-md-6 col-xs-6 border-grey">
					<div id="b1" class="pull-left boostpost-button-active  transition text-center" style="cursor:pointer;" onclick="changeButton(1);recordActionBoostPost(1);"><span>เปิด</span></div>
					<div id="b2" class="pull-left boostpost-button-inactive transition text-center" style="cursor:pointer;" onclick="$('#modalConfirmCancel').modal('show');recordActionBoostPost(2);"><span>ปิด</span></div>
				</div>
		    </div>
		    <!--end promote status-->
			<div class="clearfix"></div>
			...
			<div class="height15"></div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left padding-none-pc">
				<a href="#summaryBoost"><div id="pauseads" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-grey text-center btn-stop-boost <?=$startAdsClass;?>" onclick="recordActionBoostPost(3);">
				คลิกเพื่อหยุดชั่วคราว
				</div></a>
				<a href="#summaryBoost"><div id="showads" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-grey text-center btn-stop-boost <?=$stopAdsClass;?>" onclick="recordActionBoostPost(4);">
				คลิกเพื่อโปรโมทต่อ
				</div></a>
				<div class="clearfix"></div>
				<div class="height15"></div>
		...
		<div id="re-tab" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-bottom-grey2">
			<div id="t1" class="col-md-4 tab-boostpost-active h3boostpostedit pull-left border-grey23 padding102 text-center" onclick="changeTab(1);"><span>ผลการโปรโมท</span></div>
		    <div id="t2" class="col-md-4 tab-boostpost-inactive h3boostpostedit pull-left border-grey232 padding102 text-center" onclick="changeTab(2);"><span>แก้ไขการโปรโมท</span></div>
	    </div>
		<div id="boostpost-promote-result" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 promote-result"><!--promote's result-->
			...
			<div class="col-lg-6 col-md-6 padding-none">
				...
				<ol class="breadcrumb" style="background-color: #FFFFFF;">
					<li><a href="/zhome/boostPostEdit/<?=$POID;?>/1#boostpost-promote-result" class="<?if($date_type==1){echo "text-red";}else{echo "text-grey";}?>">ตั้งแต่เริ่ม</a></li>
					<li><a href="/zhome/boostPostEdit/<?=$POID;?>/2#boostpost-promote-result" class="<?if($date_type==2){echo "text-red";}else{echo "text-grey";}?>">สัปดาห์นี้</a></li>
					<!--<li><a href="#" class="text-grey2">สัปดาห์ที่แล้ว</a></li>-->
					<li><a href="/zhome/boostPostEdit/<?=$POID;?>/3#boostpost-promote-result" class="<?if($date_type==3){echo "text-red";}else{echo "text-grey";}?>">เดือนนี้</a></li>
					<!--<li><a href="#" class="text-grey2">เดือนที่แล้ว</a></li>-->
					<li><a href="/zhome/boostPostEdit/<?=$POID;?>/4#boostpost-promote-result" class="<?if($date_type==4){echo "text-red";}else{echo "text-grey";}?>">3 เดือน</a></li>
				</ol>
			</div>
			<div class="clearfix"></div>
			<div class="height10"></div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-none-pc">
				<div class="table-responsive">
					<table id="dataTables" class="table borderless field-table" style="min-width:720px;border-bottom:2px solid  #dfdfdd;" width="100%">
						<thead>
							<tr>
								<th>&nbsp;</th>
							...
							<tr>
								<!-- promote -->
								<th class="text-grey text-center" style="width: 10%;">วันที่</th>
								<th class="text-blue text-center" style="width: 9%;">เห็น</th>
								<th class="text-blue text-center" style="width: 9%;">คลิกดู</th>
								<th class="text-blue text-center" style="width: 9%;">% คลิก</th>
								<th class="text-blue text-center" style="width: 10%;">ดูเบอร์</th>
								<th class="text-blue text-center" style="width: 9%;">% ดูเบอร์</th>
								<th style="width: 1%;">&nbsp;</th>
								<!-- normal -->
								<th class="text-grey text-center" style="width: 9%;">คลิกดู</th>
								<th class="text-grey text-center" style="width: 9%;">% คลิก</th>
								<th class="text-grey text-center" style="width: 10%;">ดูเบอร์</th>
								<th class="text-grey text-center" style="width: 9%;">% ดูเบอร์</th>
							</tr>
						</thead>
						<tbody class="text-center">
							...
							?>
							<tr class="bg-grey2" style="font-weight: bold;">
						...
						?>
							<tr onmouseover="this.style.backgroundColor='#ffff80';" onmouseout="this.style.backgroundColor='';">
								...
								<!-- promote -->
								<td class="text-blue text-center"><?=$result[1];?></td>
								<td class="text-blue text-center"><?=$result[2];?></td>
								<td class="text-blue text-center"><?=number_format($result[3],2);?> %</td>
								<td class="text-blue text-center"><?=$result[4];?></td>
								<td class="text-blue text-center"><?=number_format($result[5],2);?> %</td>
								<td>&nbsp;</td>
								<!-- normal -->
								<td class="text-grey text-center"><?=$result[6];?></td>
								<td class="text-grey text-center"><?=number_format($result[7],2);?> %</td>
								<td class="text-grey text-center"><?=$result[8];?></td>
								<td class="text-grey text-center"><?=number_format($result[9],2);?> %</td>
							</tr>
						<?}?>
						</tbody>
					</table>
			...
			<div class="height20"></div>
			<div class="height20"></div>
			<div class="col-lg-12 col-md-12 padding-none-pc"><h3 class="text-blue padding-none h3boostpostedit">ประวัติการโปรโมท (<?echo $start_date_show2.' - '.$end_date_show;?>)</h3></div>
			<div class="clearfix"></div>
			<div class="height20"></div>
			<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12 padding-none-pc">
				<div class="table-responsive">
					<table id="dataTables2" class="table borderless field-table" style="min-width:600px;border-bottom:2px solid  #dfdfdd;" width="100%">
						<thead class="top-border-none">
							<tr class="top-border-none">
								<th class="text-grey text-center" style="width: 10%;">ลำดับ</th>
								<th class="text-grey text-center" style="width: 20%;">คำสั่ง</th>
								<th class="text-grey text-center">วันที่:เวลา</th>
								<th class="text-grey text-center" style="width: 20%;">งบสูงสุด</th>
								<th class="text-grey text-center" style="width: 20%;">วันโปรโมท</th>
							</tr>
						</thead>
						<tbody>
						<?
						...
						?>
							<tr onmouseover="this.style.backgroundColor='#ffff80';" onmouseout="this.style.backgroundColor='';">
								...
								<td class="text-grey text-center"><?=$rowHistory->ActionName;?></td>
								<td class="text-grey text-center"><?=$rowHistory->DateTime;?></td>
			...
			<div class="modal-content text-center">
				...
				<div class="modal-body modal-body-z1">
					...
					<div class="row modal-content-z1">
						...
						<div class="col-sm-10 text-center"><h4 class="text-red">กรุณาคลิกยอมรับเงื่อนไขการโฆษณา</h4></div>
						<div class="col-sm-1"></div>
					</div>
				
					<div class="row modal-bt-bottom">
						<div class="col-md-12"><button class="btn btn-blue cursor text-white" style="padding: 10px 0 10px;" data-dismiss="modal" aria-label="Close">ปิด</button></div>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal modal-sm fade display-none" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-dialog modal-dialog-z1" role="document">
			<div class="modal-content">
				...
				<div class="modal-body modal-body-z1">
					<div class="row modal-content-z3">
						<div class="col-sm-1"></div>
						<div class="col-sm-10"><h4>-&nbsp&nbsp;โปรโมทประกาศเป็นเวลา <span id="showCountDay"></span> วัน<br>โดยแสดงสูงสุดไม่เกิน<span id="showCountCredit"></span> ครั้ง/วัน</h4></div>
						<div class="col-sm-1"></div>
					
				
						<div class="col-sm-1"></div>
						<div class="col-sm-10"><h4>โฆษณาของคุณจะหยุดแสดงเมื่อ</h4></div>
						<div class="col-sm-1"></div>
					
					
						<div class="col-sm-1"></div>
						<div class="col-sm-10"><h4>1) เลยวันที่คุณกำหนด</h4></div>
						<div class="col-sm-1"></div>
				
						<div class="col-sm-1"></div>
						<div class="col-sm-10"><h4>2) ครบโควต้าแต่ละวัน</h4></div>
						<div class="col-sm-1"></div>
					
					
						<div class="col-sm-1"></div>
						<div class="col-sm-10"><h4>3) เหรียญของคุณหมด</h4></div>
						<div class="col-sm-1"></div>
				
					
					</div>
					<div class="row modal-bt-bottom2">
						<div class="col-md-12"><button name="submit_form" class="btn bg-orange cursor input-z col-xs-12 text-white" onclick="$('#boostpostform').submit();recordActionBoostPost(5);">ยืนยัน</button></div>
					</div>
					<div class="row modal-bt-bottom">
						<div class="col-md-12"><button class="btn bg-grey4 cursor input-z col-xs-12 text-white" data-dismiss="modal" aria-label="Close">ยกเลิก</button></div>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal modal-sm fade display-none" id="modalConfirmCancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-dialog modal-dialog-z1" role="document">
			<div class="modal-content">
				...
				<div class="modal-body modal-body-z1">
				  <div class="row modal-content-z4 font19">
					<div class="col-md-12 padding-none">
						<div class="col-sm-1"></div>
						<div class="col-sm-10 text-center"><h4 class="text-red">คุณต้องการยกเลิกการโปรโมท ?</h4></div>
						<div class="col-sm-1"></div>
					</div>
				  </div>
		
					<div class="row modal-bt-bottom2">
						<div style="padding: 10px;"><button name="submit_cancel" class="btn bg-orange cursor input-z col-xs-12 text-white" onclick="cancelBoostPost();recordActionBoostPost(2);">ยืนยัน</button></div>
					</div>
					<div class="row modal-bt-bottom">
...
$(document).ready(function() {
	...
	$('#dataTables').DataTable({
		...
		"dom": "<'col-sm-12 col-xs-12'tr><'col-sm-6 col-xs-12'p>",
		"language": {
...
function changeTab(type){
	if(type==1){
		$('#t1').removeClass('tab-boostpost-inactive');
		$('#t1').addClass('tab-boostpost-active');
		$('#t2').removeClass('tab-boostpost-active');
		$('#t2').addClass('tab-boostpost-inactive');
		//$("html, body").animate({ scrollTop: $('#boostpost-promote-result').offset().top }, 500);
		$('.promote-result').removeClass('display-none');
		$('.boostpost-edit').addClass('display-none');
	}else if(type==2){
		$('#t1').removeClass('tab-boostpost-active');
		$('#t1').addClass('tab-boostpost-inactive');
		$('#t2').removeClass('tab-boostpost-inactive');
		$('#t2').addClass('tab-boostpost-active');
		//$("html, body").animate({ scrollTop: $('#boostpost-edit-id').offset().top }, 500);
...
function recordActionBoostPost(ActionID){
	var JobID=$('#JobID').val();
	$.post('/zhome/recordActionBoostPost', {JobID : JobID,ActionID : ActionID} ,function(res){
	});
}
</script>