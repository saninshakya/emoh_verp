            ...
            <div class="row">
              ...
              <div id="dash-list" class="col-md-4 col-xs-6 padding-l0">
                <div style="height:50px;">
                  <h4 class="text-grey"><?=$prefix." ".$ProjectName?><h4>
<?php
...
?>
                ...
                <div class="text-grey i5-paading-top8"> 
					...
					<?php 
						if ($NumExpire<30){
					?>
						<!--<a class="text-white" href="/zhome/AddDateExpire/<?=$Token?>"> + 2 เดือนฟรี </a>-->
						<span onclick="location.href='/zhome/AddDateExpire/<?=$Token?>'"> +2เดือนฟรี</span>
					<?php
						}
					?>
					</button>
              ...
              <div id="dash-list2" class="col-md-4 col-xs-6 padding-lr0">
                <div style="height:60px;">
                 ...
                 <div class="text-blue padding-l1">
                    <span class="glyphicon glyphicon-eye-open text-blue padding-none"></span>
                 ...
                 <div class="i5-paading-top8">
                  <!--<a class="text-red underline" href="#" title="ยังไม่เปิดใหัใช้งาน"><span class="glyphicon glyphicon-earphone text-blue display-none"></span> ขายด่วน 90วัน</a>&nbsp;&nbsp;&nbsp;
