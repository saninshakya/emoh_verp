...
<div id="boostpostview" class="container padding-right-clear padding-left-clear">
...
<input type="hidden" id="date_type" name="date_type" value="<?=$date_type;?>">
	...
	<div class="padding-none">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 padding-none-pc">
			...
			<div class="height15"></div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left padding-none-pc">
				<a href="#summaryBoost" class="resume-bt display" onclick="showads2()">
				    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-grey text-center btn-start-boost2" onclick="changeTab(2);">
				     	โปรโมทเพิ่ม
					</div>
				</a>
				<div class="clearfix"></div>
		...
		<div id="re-tab" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-bottom-grey2">
		    ...
		    <div id="t2" class="col-md-4 tab-boostpost-inactive h3boostpostedit pull-left border-grey232 padding102 text-center" onclick="changeTab(2);"><span>โปรโมทเพิ่ม</span></div>
	    </div>
		<div id="boostpost-promote-result" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 promote-result"><!--promote's result-->
			...
			<div class="col-lg-12 col-md-12 padding-none">
				...
				<ol class="breadcrumb" style="background-color: #FFFFFF;">
					<li><a href="/zhome/boostPostView/<?=$POID;?>/1#boostpost-promote-result" class="<?if($date_type==1){echo "text-red";}else{echo "text-grey";}?>">ตั้งแต่เริ่ม</a></li>
					<li><a href="/zhome/boostPostView/<?=$POID;?>/2#boostpost-promote-result" class="<?if($date_type==2){echo "text-red";}else{echo "text-grey";}?>">สัปดาห์นี้</a></li>
					<!--<li><a href="#" class="text-grey2">สัปดาห์ที่แล้ว</a></li>-->
					<li><a href="/zhome/boostPostView/<?=$POID;?>/3#boostpost-promote-result" class="<?if($date_type==3){echo "text-red";}else{echo "text-grey";}?>">เดือนนี้</a></li>
					<!--<li><a href="#" class="text-grey2">เดือนที่แล้ว</a></li>-->
					<li><a href="/zhome/boostPostView/<?=$POID;?>/4#boostpost-promote-result" class="<?if($date_type==4){echo "text-red";}else{echo "text-grey";}?>">3 เดือน</a></li>
				</ol>
			</div>
			<div class="clearfix"></div>
			<div class="height10"></div>
					...
					<table id="dataTables" class="table borderless field-table" style="min-width:720px;border-bottom:2px solid  #dfdfdd;" width="100%">
						...
						<tbody class="text-center">
							...
							<tr class="bg-grey2" style="font-weight: bold;">
								<td class="text-grey text-center"><b>รวม</b></td>
								<!-- promote -->
